...
const updateGroup = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { chatId, groupName, groupImage, groupDescription, members, admins, account = null, signer = null, env = constants_1.default.ENV.PROD, pgpPrivateKey = null, scheduleAt, scheduleEnd, status, meta, } = options || {};
    try {
        ...
        (0, helpers_2.updateGroupRequestValidator)(chatId, groupName, groupDescription, members, admins, address);
        ...
        const body = (0, helpers_2.updateGroupPayload)(groupName, groupImage, groupDescription, convertedMembers, convertedAdmins, connectedUser.did, verificationProof, scheduleAt, scheduleEnd, status, meta);
