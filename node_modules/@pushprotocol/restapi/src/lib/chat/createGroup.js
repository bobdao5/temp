...
const createGroup = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { account = null, signer = null, groupName, groupDescription, members, groupImage, admins, isPublic, contractAddressNFT, numberOfNFTs, contractAddressERC20, numberOfERC20, env = constants_1.default.ENV.PROD, pgpPrivateKey = null, meta, groupType, scheduleAt, scheduleEnd } = options || {};
    try {
        ...
        const body = (0, helpers_2.createGroupPayload)(groupName, groupDescription, convertedMembers, groupImage, convertedAdmins, isPublic, connectedUser.did, verificationProof, contractAddressNFT, numberOfNFTs, contractAddressERC20, numberOfERC20, meta, groupType, scheduleAt, scheduleEnd);
