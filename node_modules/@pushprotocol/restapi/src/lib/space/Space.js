...
exports.Space = exports.initSpaceData = void 0;
...
const addSpeaker_1 = require("./addSpeaker");
const removeSpeaker_1 = require("./removeSpeaker");
...
exports.initSpaceData = Object.assign(Object.assign({}, initSpaceSpecificData), { connectionData: video_1.initVideoCallData });
...
class Space extends video_1.Video {
    constructor(options) {
        ...
        super({
            ...
            onReceiveStream: (receivedStream) => {
                var _a;
                ...
                if (this.spaceSpecificData.status === types_1.ChatStatus.ACTIVE &&
                    ...
                    (0, addToMergedStream_1.default)(this.mergeStreamObject, receivedStream);
                }
            },
            setData: function () {
                return;
        ...
        */
        this.addSpeaker = addSpeaker_1.addSpeaker;
        this.removeSpeaker = removeSpeaker_1.removeSpeaker;
        /*
