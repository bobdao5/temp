...
var socket = require('@pushprotocol/socket');
var ethers = require('ethers');
var Resolution = require('@unstoppabledomains/resolution');
var moment = require('moment');
var react = require('@livepeer/react');
require('font-awesome/css/font-awesome.min.css');
var EmojiPicker = require('emoji-picker-react');
var GifPicker = require('gif-picker-react');
...
var Resolution__default = /*#__PURE__*/_interopDefaultLegacy(Resolution);
var moment__default = /*#__PURE__*/_interopDefaultLegacy(moment);
var EmojiPicker__default = /*#__PURE__*/_interopDefaultLegacy(EmojiPicker);
var GifPicker__default = /*#__PURE__*/_interopDefaultLegacy(GifPicker);
...
var CircularProgressSpinner$1 = /*#__PURE__*/React__namespace.memo(CircularProgressSpinner);
...
const DecryptButton = ({
  ...
  return jsxRuntime.jsx(ActionButton, Object.assign({
    ...
    children: isLoading ? jsxRuntime.jsx(CircularProgressSpinner$1, {}) : btnText
  }));
};
...
const Tooltip$1 = ({
  ...
  return jsxRuntime.jsxs(Wrapper, Object.assign({
    ...
    children: [children, active && jsxRuntime.jsx(Content, {
...
const createSVGIcon = (element, chainName) => {
  return jsxRuntime.jsx(Tooltip$1, Object.assign({
...
var chainDetails = {
  ETH_TEST_GOERLI: {
    ...
    icon: createSVGIcon(jsxRuntime.jsx(EthereumSvg, {}), 'Ethereum Goerli')
  },
  ETH_MAINNET: {
    label: 'ETHEREUM MAINNET',
    icon: createSVGIcon(jsxRuntime.jsx(EthereumSvg, {}), 'Ethereum Mainnet')
  },
  POLYGON_TEST_MUMBAI: {
    label: 'POLYGON MUMBAI',
    icon: createSVGIcon(jsxRuntime.jsx(PolygonSvg, {}), 'Polygon Mumbai')
  },
  POLYGON_MAINNET: {
    label: 'POLYGON MAINNET',
    icon: createSVGIcon(jsxRuntime.jsx(PolygonSvg, {}), 'Polygon Mainnet')
  },
  BSC_TESTNET: {
    label: 'BSC TESTNET',
    icon: createSVGIcon(jsxRuntime.jsx(BSCSvg, {}), 'Bsc Testnet')
  },
  BSC_MAINNET: {
    label: 'BSC MAINNET',
    icon: createSVGIcon(jsxRuntime.jsx(BSCSvg, {}), 'Bsc Mainnet')
  },
  OPTIMISM_TESTNET: {
    label: 'OPTIMISM TESTNET',
    icon: createSVGIcon(jsxRuntime.jsx(OptimismSvg, {}), 'Optimism Testnet')
  },
  OPTIMISM_MAINNET: {
    label: 'OPTIMISM MAINNET',
    icon: createSVGIcon(jsxRuntime.jsx(OptimismSvg, {}), 'Optimism Mainnet')
  },
  POLYGON_ZK_EVM_TESTNET: {
    label: 'POLYGON ZK EVM TESTNET',
    icon: createSVGIcon(jsxRuntime.jsx(PolygonzkevmSvg, {}), 'Polygon ZK EVM Testnet')
  },
  POLYGON_ZK_EVM_MAINNET: {
    label: 'POLYGON ZK EVM MAINNET',
    icon: createSVGIcon(jsxRuntime.jsx(PolygonzkevmSvg, {}), 'Polygon ZK EVM Mainnet')
  },
  THE_GRAPH: {
    label: 'THE GRAPH',
    icon: createSVGIcon(jsxRuntime.jsx(TheGraphSvg, {}), 'The Graph')
  }
};
...
const allowedNetworks = {
  'prod': [1, 137, 56 // for bnb mainnet
  // 10 // for optimism mainnet
  ],
  'dev': [5, 80001, 97, 420 // optimism goerli testnet
  ],
  'staging': [// 42, //for kovan
  5, 80001, 97 // bnb testnet
  ],
  'local': [5, 80001, 97, 420 // optimism goerli testnet
  ]
};
...
const FILE_ICON = extension => `https://cdn.jsdelivr.net/gh/napthedev/file-icons/file/${extension}.svg`;
...
const commonStyle = /*#__PURE__*/styled.css(["display:", ";position:", ";background:", ";color:", ";cursor:", ";flex:", ";flex-direction:", ";flex-wrap:", ";gap:", ";align-self:", ";align-items:", ";align-content:", ";justify-content:", ";padding:", ";margin:", ";margin-top:", ";margin-left:", ";margin-right:", ";margin-bottom:", ";min-width:", ";max-width:", ";overflow-y:", ";font-size:", ";font-weight:", ";text-align:", ";filter:", ";box-shadow:", ";top:", ";bottom:", ";left:", ";right:", ";width:", ";height:", ";border:", ";border-radius:", ";overflow:", ";z-index:", ";"], props => props.display, props => props.position, props => props.background, props => props.color, props => props.cursor, props => props.flex, props => props.flexDirection, props => props.flexWrap, props => props.gap, props => props.alignSelf, props => props.alignItems, props => props.alignContent, props => props.justifyContent, props => props.padding, props => props.margin, props => props.marginTop, props => props.marginLeft, props => props.marginRight, props => props.marginBottom, props => props.minWidth, props => props.maxWidth, props => props.overflowY, props => props.fontSize, props => props.fontWeight, props => props.textAlign, props => props.filter, props => props.boxShadow, props => props.top, props => props.bottom, props => props.left, props => props.right, props => props.width, props => props.height, props => props.border, props => props.borderRadius, props => props.overflow, props => props.zIndex);
const Item$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "styles__Item",
  componentId: "sc-1il8o4s-0"
})(["", ""], commonStyle);
const Anchor = /*#__PURE__*/styled__default["default"].a.withConfig({
  displayName: "styles__Anchor",
  componentId: "sc-1il8o4s-1"
})(["", ""], commonStyle);
const Container$j = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Heading$1 = /*#__PURE__*/styled__default["default"].h1.withConfig({
  displayName: "styles__Heading",
  componentId: "sc-1il8o4s-4"
})(["", ""], commonStyle);
const Button$6 = /*#__PURE__*/styled__default["default"].button.withConfig({
  displayName: "styles__Button",
  componentId: "sc-1il8o4s-5"
})(["", ""], commonStyle);
const Text$1 = /*#__PURE__*/styled__default["default"].span.withConfig({
...
const SpaceDataContext = /*#__PURE__*/React.createContext(initialSpaceDataContextValues);

const SupportChatPropsContext = /*#__PURE__*/React.createContext({});

const SupportChatMainStateContext = /*#__PURE__*/React.createContext({});
...
const ChatMainStateContextProvider = ({
  ...
  const [web3NameList, setWeb3NameList] = React.useState({});
  const [connectedProfile, setConnectedProfile] = React.useState(undefined);
  const [chatsFeed, setChatsFeed] = React.useState({});
  const [requestsFeed, setRequestsFeed] = React.useState({});
  const [chats, setChats] = React.useState(new Map());
  const [selectedChatId, setSelectedChatId] = React.useState(null);
  const [searchedChats, setSearchedChats] = React.useState(null);
  ...
  return jsxRuntime.jsx(ChatMainStateContext.Provider, Object.assign({
    value: {
      chatsFeed,
      requestsFeed,
      setRequestFeed,
...
const ChatAndNotificationPropsContext = /*#__PURE__*/React.createContext({});

const NotificationMainStateContext = /*#__PURE__*/React.createContext({});

const NotificationMainStateContextProvider = ({
  children
}) => {
  const [inboxNotifsFeed, setInboxNotifsFeed] = React.useState({});
  const [allInboxNotifFeed, setAllInboxNotifsFeed] = React.useState({});
  const [spamNotifsFeed, setSpamNotifsFeed] = React.useState({});
  const [subscriptionStatus, setSubscriptionStatus] = React.useState(new Map());
  const [searchedNotifications, setSearchedNotifications] = React.useState(null);
  ...
  return jsxRuntime.jsx(NotificationMainStateContext.Provider, Object.assign({
    value: {
      inboxNotifsFeed,
      setInboxNotifFeed,
      setInboxNotifsFeed,
...
const ChatAndNotificationMainContext = /*#__PURE__*/React.createContext({});

const ChatAndNotificationMainContextProvider = ({
  children
}) => {
  const [activeTab, setTab] = React.useState(PUSH_TABS.CHATS);
  const [activeSubTab, setSubTab] = React.useState(null);
  ...
  return jsxRuntime.jsx(ChatAndNotificationMainContext.Provider, Object.assign({
    value: {
      newChat,
      setNewChat,
      activeTab,
...
const useSpaceData = () => {
  const context = React.useContext(SpaceDataContext);
...
const useGetSpaceInfo = spaceId => {
  const {
    ...
    setSpaceInfo,
    env
  } = React.useContext(SpaceDataContext);
  const [spaceData, setSpaceDataState] = React.useState(getSpaceInfo(spaceId));
  React.useEffect(() => {
    if (!spaceId) {
      return;
    }
    ...
    const fetchData = () => __awaiter(void 0, void 0, void 0, function* () {
      if (!spaceData) {
        try {
          const response = yield PushAPI__namespace.space.get({
            spaceId,
            env
          });
...
const usePopularSpaces = () => {
  ...
  const fetchPopularSpaces = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const res = yield PushAPI__namespace.space.trending({
...
const useMySpaces = account => {
  ...
  const fetchMySpaces = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const res = yield PushAPI__namespace.space.spaces({
        account: account,
...
const useSpaceRequests = account => {
  ...
  const fetchSpaceRequests = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const res = yield PushAPI__namespace.space.requests({
        account: account,
...
const useSpaceNotificationSocket = ({
  account,
  env: _env = exports.ENV.PROD
}) => {
  const {
    spacesObjectRef
  } = useSpaceData();
  const [notificationSocket, setNotificationSocket] = React.useState(null);
  const [isNotificationSocketConnected, setIsNotificationSocketConnected] = React.useState(false);
  const addSocketEvents = React.useCallback(() => {
    notificationSocket === null || notificationSocket === void 0 ? void 0 : notificationSocket.on(socket.EVENTS.CONNECT, () => {
      setIsNotificationSocketConnected(true);
    });
    notificationSocket === null || notificationSocket === void 0 ? void 0 : notificationSocket.on(socket.EVENTS.DISCONNECT, () => {
      setIsNotificationSocketConnected(false);
    });
    notificationSocket === null || notificationSocket === void 0 ? void 0 : notificationSocket.on(socket.EVENTS.USER_FEEDS, feedItem => {
      var _a, _b, _c, _d, _e;
      ...
      if (((_b = (_a = payload === null || payload === void 0 ? void 0 : payload.data) === null || _a === void 0 ? void 0 : _a.additionalMeta) === null || _b === void 0 ? void 0 : _b.type) === `${PushAPI__namespace.payloads.ADDITIONAL_META_TYPE.PUSH_VIDEO}+1`) {
        const {
          status,
          callDetails,
          senderAddress,
          ...
          signalData,
          chatId
        } = JSON.parse(payload.data.additionalMeta.data);

        if (status === PushAPI__namespace.VideoCallStatus.INITIALIZED) {
          if ((callDetails === null || callDetails === void 0 ? void 0 : callDetails.type) === PushAPI__namespace.payloads.SPACE_REQUEST_TYPE.JOIN_SPEAKER) {
            // TODO: see if check for speaker is req
            (_c = spacesObjectRef.current) === null || _c === void 0 ? void 0 : _c.acceptRequest({
          ...
          if ((callDetails === null || callDetails === void 0 ? void 0 : callDetails.type) === PushAPI__namespace.payloads.SPACE_REQUEST_TYPE.ESTABLISH_MESH) {
            (_d = spacesObjectRef.current) === null || _d === void 0 ? void 0 : _d.acceptRequest({
              signalData,
              senderAddress: recipientAddress,
              recipientAddress: senderAddress,
              chatId: chatId
        ...
        if (status === PushAPI__namespace.VideoCallStatus.RECEIVED) {
          (_e = spacesObjectRef.current) === null || _e === void 0 ? void 0 : _e.connect({
            signalData,
            peerAddress: senderAddress
          });
        }

        if (status === PushAPI__namespace.VideoCallStatus.DISCONNECTED) {
          if ((callDetails === null || callDetails === void 0 ? void 0 : callDetails.type) === PushAPI__namespace.payloads.SPACE_DISCONNECT_TYPE.LEAVE) ;

          if ((callDetails === null || callDetails === void 0 ? void 0 : callDetails.type) === PushAPI__namespace.payloads.SPACE_DISCONNECT_TYPE.STOP) ;
        }
      }
    });
  }, [notificationSocket]);
  const removeSocketEvents = React.useCallback(() => {
    notificationSocket === null || notificationSocket === void 0 ? void 0 : notificationSocket.off(socket.EVENTS.CONNECT);
    notificationSocket === null || notificationSocket === void 0 ? void 0 : notificationSocket.off(socket.EVENTS.DISCONNECT);
    notificationSocket === null || notificationSocket === void 0 ? void 0 : notificationSocket.off(socket.EVENTS.USER_FEEDS);
  }, [notificationSocket]);
  React.useEffect(() => {
  ...
  React.useEffect(() => {
    if (account) {
      ...
      const main = () => __awaiter(void 0, void 0, void 0, function* () {
        const connectionObject = socket.createSocketConnection({
          user: account,
          env: _env,
...
const usePushSpaceSocket = ({
  ...
  const [pushSpaceSocket, setPushSpaceSocket] = React.useState(null);
  const [isPushSDKSocketConnected, setIsPushSDKSocketConnected] = React.useState(false);
  const addSocketEvents = React.useCallback(() => {
    pushSpaceSocket === null || pushSpaceSocket === void 0 ? void 0 : pushSpaceSocket.on(socket.EVENTS.CONNECT, () => {
      setIsPushSDKSocketConnected(true);
    });
    pushSpaceSocket === null || pushSpaceSocket === void 0 ? void 0 : pushSpaceSocket.on(socket.EVENTS.DISCONNECT, () => {
      setIsPushSDKSocketConnected(false);
    });
    pushSpaceSocket === null || pushSpaceSocket === void 0 ? void 0 : pushSpaceSocket.on(socket.EVENTS.CHAT_RECEIVED_MESSAGE, () => __awaiter(void 0, void 0, void 0, function* () {
      /** */
    }));
    pushSpaceSocket === null || pushSpaceSocket === void 0 ? void 0 : pushSpaceSocket.on('SPACES', spaceInfo => {
      var _a;

      console.log(spaceInfo);
      const updatedData = (_a = spaceRequests === null || spaceRequests === void 0 ? void 0 : spaceRequests.apiData) === null || _a === void 0 ? void 0 : _a.map(item => {
  ...
  const removeSocketEvents = React.useCallback(() => {
    pushSpaceSocket === null || pushSpaceSocket === void 0 ? void 0 : pushSpaceSocket.off(socket.EVENTS.CONNECT);
    pushSpaceSocket === null || pushSpaceSocket === void 0 ? void 0 : pushSpaceSocket.off(socket.EVENTS.DISCONNECT);
    pushSpaceSocket === null || pushSpaceSocket === void 0 ? void 0 : pushSpaceSocket.off(socket.EVENTS.CHAT_GROUPS);
    pushSpaceSocket === null || pushSpaceSocket === void 0 ? void 0 : pushSpaceSocket.off(socket.EVENTS.CHAT_RECEIVED_MESSAGE);
  }, [pushSpaceSocket]);
  React.useEffect(() => {
    if (pushSpaceSocket) {
      addSocketEvents();
...
const useFetchChats = () => {
  ...
  const {
    ...
    env,
    decryptedPgpPvtKey
  } = React.useContext(ChatAndNotificationPropsContext);
  const fetchChats = React.useCallback(({
    ...
    try {
      const chats = yield PushAPI__namespace.chat.chats({
        account: account,
...
const useFetchRequests = () => {
  ...
  const fetchRequests = React.useCallback(({
    ...
    try {
      const requests = yield PushAPI__namespace.chat.requests({
        account: account,
        toDecrypt: decryptedPgpPvtKey ? true : false,
        pgpPrivateKey: String(decryptedPgpPvtKey),
        page,
...
const useFetchHistoryMessages = () => {
  ...
  const historyMessages = React.useCallback(({
    threadHash,
    limit: _limit = 10
  }) => __awaiter(void 0, void 0, void 0, function* () {
    setLoading(true);
    ...
    try {
      const chatHistory = yield PushAPI__namespace.chat.history({
...
const useApproveChatRequest = () => {
  ...
  const approveChatRequest = React.useCallback(options => __awaiter(void 0, void 0, void 0, function* () {
    const {
      senderAddress
    } = options || {};
    setLoading(true);
    ...
    try {
      const response = yield PushAPI__namespace.chat.approve({
        status: 'Approved',
        account: account,
...
const useFetchChat = () => {
  ...
  const fetchChat = React.useCallback(({
    ...
    try {
      const chat = yield PushAPI__namespace.chat.chat({
        account: account,
        toDecrypt: decryptedPgpPvtKey ? true : false,
        pgpPrivateKey: String(decryptedPgpPvtKey),
...
const usePushSendMessage = () => {
  ...
  useFetchChat();
  const sendMessage = React.useCallback(options => __awaiter(void 0, void 0, void 0, function* () {
    const {
      receiver,
      message,
      messageType
    ...
    try {
      const response = yield PushAPI__namespace.chat.send({
...
const useGetChatProfile = () => {
  ...
  const fetchChatProfile = React.useCallback(({
    profileId
  }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
      const profile = yield PushAPI__namespace.user.get({
        env: env,
        account: profileId
      });
      return profile;
...
const useSDKSocket = ({
  ...
  const [epnsSDKSocket, setEpnsSDKSocket] = React.useState(null);
  const [messagesSinceLastConnection, setMessagesSinceLastConnection] = React.useState('');
  const [isSDKSocketConnected, setIsSDKSocketConnected] = React.useState(epnsSDKSocket === null || epnsSDKSocket === void 0 ? void 0 : epnsSDKSocket.connected);

  const addSocketEvents = () => {
    console.warn('\n--> addSocketEvents');
    epnsSDKSocket === null || epnsSDKSocket === void 0 ? void 0 : epnsSDKSocket.on(socket.EVENTS.CONNECT, () => {
      console.log('CONNECTED: ');
      setIsSDKSocketConnected(true);
    });
    epnsSDKSocket === null || epnsSDKSocket === void 0 ? void 0 : epnsSDKSocket.on(socket.EVENTS.DISCONNECT, err => {
      console.log('DIS-CONNECTED: ', err);
      setIsSDKSocketConnected(false);
    });
    console.log('\t-->will attach eachMessage event now');
    epnsSDKSocket === null || epnsSDKSocket === void 0 ? void 0 : epnsSDKSocket.on(socket.EVENTS.CHAT_RECEIVED_MESSAGE, chat => {
      /**
       * We receive a 1 message.
       */
      console.log("\n\n\n\neachMessage event: ", chat); // do stuff with data
  ...
  const removeSocketEvents = () => {
    console.warn('\n--> removeSocketEvents');
    epnsSDKSocket === null || epnsSDKSocket === void 0 ? void 0 : epnsSDKSocket.off(socket.EVENTS.CONNECT);
    epnsSDKSocket === null || epnsSDKSocket === void 0 ? void 0 : epnsSDKSocket.off(socket.EVENTS.DISCONNECT);
  };
  ...
  React.useEffect(() => {
    if (account) {
      if (epnsSDKSocket) {
        // console.log('=================>>> disconnection in the hook');
        epnsSDKSocket === null || epnsSDKSocket === void 0 ? void 0 : epnsSDKSocket.disconnect();
      }
...
const createUserIfNecessary = options => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const decryptedPrivateKey = yield PushAPI__namespace.chat.decryptPGPKey({
...
const getChats = options => __awaiter(void 0, void 0, void 0, function* () {
  ...
  let threadhash = threadHash;

  if (!threadhash) {
    threadhash = yield PushAPI__namespace.chat.conversationHash({
      account: account,
  ...
  return {
    chatsResponse: [],
    lastThreadHash: null,
    lastListPresent: false
  };
});
const decryptChat = options => __awaiter(void 0, void 0, void 0, function* () {
  const {
    message,
    connectedUser,
    env = Constants.ENV.PROD
  } = options || {};
  const decryptedChat = yield PushAPI__namespace.chat.decryptConversation({
    messages: [message],
    connectedUser,
...
const getDefaultFeedObject = ({
  ...
  const feed = {
    ...
    did: user.did,
    threadhash: null,
    profilePicture: (_a = user === null || user === void 0 ? void 0 : user.profile) === null || _a === void 0 ? void 0 : _a.picture,
    name: null,
    about: user.about,
    intent: null,
    intentSentBy: null,
...
const getUdResolver = env => {
  ...
  return Resolution__default["default"].fromEthersProvider({
    uns: {
      locations: {
        Layer1: {
          network: NETWORK_DETAILS[l1ChainId].network,
          provider: new ethers.ethers.providers.InfuraProvider(l1ChainId, InfuraAPIKey)
        },
        Layer2: {
          network: NETWORK_DETAILS[l2ChainId].network,
          provider: new ethers.ethers.providers.InfuraProvider(l2ChainId, InfuraAPIKey)
        }
      }
    }
  });
...
const getNewChatUser = ({
  ...
  let chatProfile;
  let address = null;
  address = yield getAddress(searchText, env);
...
const getAddress = (searchText, env) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const provider = new ethers.ethers.providers.InfuraProvider(CoreContractChainId[env], InfuraAPIKey);
  let address = null;

  if (searchText.includes('.')) {
    try {
      address = (yield udResolver.owner(searchText)) || (yield provider.resolveName(searchText)); // (await library.resolveName(searchText)) ||
  ...
  } else if (yield ethers.ethers.utils.isAddress(pCAIP10ToWallet(searchText))) {
    return searchText;
  } else {
    return null;
  }
...
const dateToFromNowDaily = timestamp => {
  const timestampDate = moment__default["default"](timestamp).calendar(null, {
    lastWeek: ' dddd',
    lastDay: '[Yesterday]',
    sameDay: '[Today]',
    nextWeek: 'dddd',
...
$$4({ target: 'Number', proto: true, forced: FORCED$2 }, {
...
const formatDate = date => {
  const formattedDate = moment__default["default"](date).format('Do MMM [at] h:mm A');
  ...
  React.useEffect(() => {
    (() => __awaiter(this, void 0, void 0, function* () {
      ...
      if (address) {
        ...
        const checksumWallet = ethers.ethers.utils.getAddress(walletLowercase);

        if (ethers.ethers.utils.isAddress(checksumWallet)) {
          try {
...
const convertReponseToParsedArray = response => {
  const parsedResponse = PushAPI__namespace.utils.parseApiResponse(response);
  const map1 = new Map();
  const map2 = new Map();
...
const useFetchNotification = () => {
  ...
  const fetchNotification = React.useCallback(({
    ...
    try {
      const results = yield PushAPI__namespace.user.getFeeds({
        user: account,
        raw: true,
        env: env,
        page: page,
...
const useFetchUserSubscriptions = () => {
  ...
  const {
    setSubscriptionStatus
  } = React.useContext(NotificationMainStateContext);
  const fetchUserSubscriptions = React.useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
    setLoading(true);

    try {
      const chainId = yield signer.getChainId();
      const results = yield PushAPI__namespace.user.getSubscriptions({
...
const useOnSubscribeToChannel = () => {
  ...
  const onSubscribeToChannel = React.useCallback(({
    channelAddress
  }) => __awaiter(void 0, void 0, void 0, function* () {
    setLoading(true);
    ...
    try {
      ...
      console.log(signer);
      const chainId = yield signer.getChainId();
      yield PushAPI__namespace.channels.subscribe({
        signer: signer,
...
const useChatNotificationSocket = ({
  socketType: _socketType = CHAT_SOCKET_TYPE.NOTIFICATION
}) => {
  const [isSDKSocketConnected, setIsSDKSocketConnected] = React.useState(false);
  const [messagesSinceLastConnection, setMessagesSinceLastConnection] = React.useState('');
  const [groupInformationSinceLastConnection, setGroupInformationSinceLastConnection] = React.useState('');
  const [notificationFeedSinceLastConnection, setNotificationFeedSinceLastConnection] = React.useState('');
  const {
    fetchChat
  } = useFetchChat();
  const {
  ...
  const [pushChatNotificationSocket, setPushChatNotificationSocket] = React.useState(null);
  const addSocketEvents = React.useCallback(() => {
    pushChatNotificationSocket === null || pushChatNotificationSocket === void 0 ? void 0 : pushChatNotificationSocket.on(socket.EVENTS.CONNECT, () => {
      setIsSDKSocketConnected(true);
    });
    pushChatNotificationSocket === null || pushChatNotificationSocket === void 0 ? void 0 : pushChatNotificationSocket.on(socket.EVENTS.DISCONNECT, err => {
      console.log(err);
      setIsSDKSocketConnected(false);
    });
    pushChatNotificationSocket === null || pushChatNotificationSocket === void 0 ? void 0 : pushChatNotificationSocket.on(socket.EVENTS.USER_FEEDS, feedItem => {
    ...
    pushChatNotificationSocket === null || pushChatNotificationSocket === void 0 ? void 0 : pushChatNotificationSocket.on(socket.EVENTS.CHAT_RECEIVED_MESSAGE, chat => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const response = yield PushAPI__namespace.chat.decryptConversation({
        messages: [chat],
    ...
    pushChatNotificationSocket === null || pushChatNotificationSocket === void 0 ? void 0 : pushChatNotificationSocket.on(socket.EVENTS.CHAT_GROUPS, groupInfo => {
  ...
  const removeSocketEvents = React.useCallback(() => {
    pushChatNotificationSocket === null || pushChatNotificationSocket === void 0 ? void 0 : pushChatNotificationSocket.off(socket.EVENTS.CONNECT);
    pushChatNotificationSocket === null || pushChatNotificationSocket === void 0 ? void 0 : pushChatNotificationSocket.off(socket.EVENTS.DISCONNECT);
    pushChatNotificationSocket === null || pushChatNotificationSocket === void 0 ? void 0 : pushChatNotificationSocket.off(socket.EVENTS.CHAT_GROUPS);
    pushChatNotificationSocket === null || pushChatNotificationSocket === void 0 ? void 0 : pushChatNotificationSocket.off(socket.EVENTS.CHAT_RECEIVED_MESSAGE);
  ...
  React.useEffect(() => {
    if (decryptedPgpPvtKey) {
      ...
      const connectionObject = socket.createSocketConnection({
        user: _socketType === CHAT_SOCKET_TYPE.CHAT ? account : convertAddressToAddrCaip(account, chainId),
        socketType: _socketType,
        env: env
      });
...
const NotificationItem = ({
  ...
  return jsxRuntime.jsxs(Container$i, Object.assign({
    timestamp: timeStamp,
    theme: theme,
    ...
    children: [jsxRuntime.jsxs(MobileHeader, Object.assign({
      ...
      children: [jsxRuntime.jsxs(HeaderButton, Object.assign({
        ...
        })), jsxRuntime.jsx(ChannelName, Object.assign({
          onClick: goToURL
        }, {
          children: app
        }))]
      })), chainName && chainDetails[chainName] ? jsxRuntime.jsx(BlockchainContainer, {
        children: jsxRuntime.jsx(ChainIconSVG, Object.assign({
          offsetWidth: offsetWidth
        }, {
          children: chainDetails[chainName].icon
        }))
      }) : null]
    })), jsxRuntime.jsxs(ContentSection, Object.assign({
      themeObject: themeObject,
      offsetWidth: offsetWidth,
      ...
      jsxRuntime.jsx(MobileImage, Object.assign({
        ...
        children: [jsxRuntime.jsxs(ChannelTitle, Object.assign({
          themeObject: themeObject,
          cta: isCtaURLValid,
          offsetWidth: offsetWidth,
          theme: theme
        }, {
          children: [jsxRuntime.jsx(ChannelTitleText, Object.assign({
            themeObject: themeObject
          }, {
            children: notifTitle
          })), isCtaURLValid ? jsxRuntime.jsx("span", Object.assign({
            style: {
              height: "20px",
              marginLeft: "7px"
            }
          }, {
            children: jsxRuntime.jsx(LinkIcon, {})
          })) : ""]
        })), jsxRuntime.jsx(ChannelDesc, Object.assign({
          themeObject: themeObject
        }, {
        ...
        children: jsxRuntime.jsxs(ButtonGroup, {
          children: [isSpam && jsxRuntime.jsx(ActionButton, Object.assign({
            ...
            children: subscribeLoading ? jsxRuntime.jsx(CircularProgressSpinner$1, {}) : 'opt-in'
...
}, props => props.offsetWidth > 461 && styled.css(["@media (min-width:", "){align-items:flex-start;flex-direction:row;gap:20px;justify-content:space-between;}@media (max-width:", "){flex-direction:column;}"], SM_BREAKPOINT, SM_BREAKPOINT), props => props.offsetWidth <= 461 && styled.css(["flex-direction:column;"]));
...
})(["overflow:hidden;img,iframe,video{max-width:100% !important;width:100%;height:100% !important;object-fit:fill;border-radius:10px;border:0;}", ";", ";"], props => props.offsetWidth > 461 && styled.css(["@media (min-width:", "){border:1px solid ", ";border-radius:10px;min-width:220px;width:220px;height:200px;}@media (max-width:", "){display:block;width:100%;max-height:200px;margin-bottom:12px;border:0;img,iframe,video{border:0;border-radius:0;}}"], SM_BREAKPOINT, props => props.theme === 'light' ? '#ededed' : '#444', SM_BREAKPOINT), props => props.offsetWidth <= 461 && styled.css(["display:block;width:100%;max-height:200px;margin-bottom:12px;border:0;img,iframe,video{border:0;border-radius:0;}"]));
...
const Container$i = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const ChannelName = /*#__PURE__*/styled__default["default"].div.withConfig({
...
}, props => props.offsetWidth > 461 && styled.css(["@media (max-width:", "){margin-bottom:6px;}"], SM_BREAKPOINT), props => props.offsetWidth <= 461 && styled.css(["margin-bottom:6px;"]));
const ChannelTitleText = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const SubscribedModal = ({
  ...
  return jsxRuntime.jsx(Overlay, Object.assign({
    ...
    children: jsxRuntime.jsxs(Modal$3, Object.assign({
      className: "modal",
      ref: modalRef
    }, {
...
const Modal$3 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const SpaceBannerLoadingSkeleton = () => {
  return jsxRuntime.jsxs(SkeletonContainer, {
    children: [jsxRuntime.jsxs(SkeletonContent, {
      children: [jsxRuntime.jsx(SkeletonProfilePic, {}), jsxRuntime.jsxs(SkeletonProfileInfo, {
        children: [jsxRuntime.jsx(SkeletonName, {}), jsxRuntime.jsx(SkeletonHandle, {})]
      })]
    }), jsxRuntime.jsx(SkeletonSpaceInfo, {}), jsxRuntime.jsxs(SkeletonLine, {
      children: [jsxRuntime.jsx(SkeletonLeftSquare, {}), jsxRuntime.jsxs(SkeletonOverlap, {
        children: [jsxRuntime.jsx(SkeletonOverlapProfilePic, {}), jsxRuntime.jsx(SkeletonOverlapProfilePic, {}), jsxRuntime.jsx(SkeletonOverlapProfilePic, {})]
      })]
    })]
  });
};
const SkeletonContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonContainer",
  componentId: "sc-qo65s5-0"
})(["display:flex;flex-direction:column;gap:24px;padding:16px;background-color:#f1f1f1;border-radius:17px;border:1px solid lightgrey;position:relative;&:after{content:'';position:absolute;top:0;left:0;right:0;bottom:0;border-radius:17px;background-color:#f1f1f1;opacity:0.5;transition:opacity 0.8s ease-in-out infinite alternate;}&:hover:after{opacity:0.3;}"]);
const SkeletonContent = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonContent",
  componentId: "sc-qo65s5-1"
})(["display:flex;align-items:center;gap:10px;"]);
const SkeletonProfilePic = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonProfilePic",
  componentId: "sc-qo65s5-2"
})(["width:48px;height:48px;border-radius:50%;border:1px solid lightgrey;background-color:#d9d9d9;transition:opacity 0.8s ease-in-out infinite alternate;&:hover{opacity:0.5;}"]);
const SkeletonProfileInfo = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonProfileInfo",
  componentId: "sc-qo65s5-3"
})(["display:flex;flex-direction:column;gap:5px;width:100%;"]);
const SkeletonText = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonText",
  componentId: "sc-qo65s5-4"
})(["width:100%;height:18px;background-color:#d9d9d9;border-radius:8px;border:1px solid lightgrey;transition:opacity 0.8s ease-in-out infinite alternate;&:hover{opacity:0.5;}"]);
const SkeletonName = /*#__PURE__*/styled__default["default"](SkeletonText).withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonName",
  componentId: "sc-qo65s5-5"
})(["width:30%;"]);
const SkeletonHandle = /*#__PURE__*/styled__default["default"](SkeletonText).withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonHandle",
  componentId: "sc-qo65s5-6"
})(["width:40%;"]);
const SkeletonSpaceInfo = /*#__PURE__*/styled__default["default"](SkeletonText).withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonSpaceInfo",
  componentId: "sc-qo65s5-7"
})(["width:100%;height:30px;"]);
const SkeletonLine = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonLine",
  componentId: "sc-qo65s5-8"
})(["display:flex;align-items:center;width:100%;"]);
const SkeletonLeftSquare = /*#__PURE__*/styled__default["default"](SkeletonText).withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonLeftSquare",
  componentId: "sc-qo65s5-9"
})(["width:10%;height:32px;"]);
const SkeletonOverlap = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const SkeletonOverlapProfilePic = /*#__PURE__*/styled__default["default"](SkeletonProfilePic).withConfig({
  displayName: "SpaceBannerLoadingSkeleton__SkeletonOverlapProfilePic",
  componentId: "sc-qo65s5-11"
})(["height:48px;border:1px solid lightgrey;margin-left:-24px;transition:opacity 0.8s ease-in-out infinite alternate;&:nth-child(2){margin-left:-24px;}&:nth-child(3){margin-left:-24px;}"]);
 ...
 */
const ThemeContext = /*#__PURE__*/React.createContext(lightTheme);
...
const ParticipantContainer = ({
  ...
  return jsxRuntime.jsxs(Participants, {
    children: [jsxRuntime.jsx(ParticipantsIconContainer, Object.assign({
      orientation: orientation
    }, {
      children: orientation === 'pill' ? participants && participants.map((person, index) => index < 2 && jsxRuntime.jsx(ParticipantsIcon, {
        src: person === null || person === void 0 ? void 0 : person.image,
        alt: "avatar",
        className: `index${index}`
      })) : participants && participants.map((person, index) => index < 3 && jsxRuntime.jsx(ParticipantsIcon, {
        src: person === null || person === void 0 ? void 0 : person.image,
        alt: "avatar",
        className: `index${index}`
      }))
    })), jsxRuntime.jsx(ParticipantsText, {
...
const Participants = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "ParticipantContainer__Participants",
  componentId: "sc-1fgkl2u-0"
})(["display:flex;flex-direction:row;align-items:center;justify-content:space-between;}"]);
const ParticipantsIconContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const ParticipantsIcon = /*#__PURE__*/styled__default["default"].img.withConfig({
  displayName: "ParticipantContainer__ParticipantsIcon",
  componentId: "sc-1fgkl2u-2"
})(["  height:", ";border-radius:50%;&.index0{position:relative;top:0;left:0;z-index:3;}&.index1{position:relative;top:0;left:-50%;z-index:2;}&.index2{position:relative;top:0;left:-100%;z-index:1;}}"], props => props.imageHeight ? props.imageHeight : '31px');
const ParticipantsText = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const HostPfpContainer = ({
  ...
  return jsxRuntime.jsxs(ProfileContainer$1, {
    children: [jsxRuntime.jsx(PfpContainer$1, {
      children: jsxRuntime.jsx(Pfp$1, {
        src: _imageUrl,
        alt: "host pfp",
        imageHeight: imageHeight
      })
    }), jsxRuntime.jsxs(HostContainer$1, {
      children: [jsxRuntime.jsxs(HostName$1, {
        children: [jsxRuntime.jsx(Name$1, {
          children: _name
        }), jsxRuntime.jsx(Host$1, Object.assign({
          statusTheme: statusTheme
        }, {
          children: "Host"
        }))]
      }), _handle && jsxRuntime.jsxs(HostHandle$1, Object.assign({
        statusTheme: statusTheme
      }, {
        children: ["@", _handle]
      }))]
...
const ProfileContainer$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const PfpContainer$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "HostPfpContainer__PfpContainer",
  componentId: "sc-vviclm-1"
})(["display:flex;"]);
const Pfp$1 = /*#__PURE__*/styled__default["default"].img.withConfig({
...
const HostContainer$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const HostName$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Name$1 = /*#__PURE__*/styled__default["default"].span.withConfig({
  displayName: "HostPfpContainer__Name",
  componentId: "sc-vviclm-5"
})(["text-overflow:ellipsis;white-space:nowrap;overflow:hidden;"]);
const Host$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "HostPfpContainer__Host",
  componentId: "sc-vviclm-6"
})(["display:flex;flex-direction:row;align-items:center;padding:2px 8px;margin-left:8px;line-height:18px;width:max-content;height:19px;background:", ";color:", ";border-radius:6px;font-weight:500;font-size:10px;"], props => props.statusTheme === 'Live' ? 'rgba(255, 255, 255, 0.2);' : 'rgba(139, 92, 246, 0.2)', props => props.statusTheme === 'Live' ? 'inherit' : '#8B5CF6');
const HostHandle$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "HostPfpContainer__HostHandle",
  componentId: "sc-vviclm-7"
})(["color:", ";padding:0;font-weight:450;font-size:14px;line-height:130%;width:100%;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;"], props => props.statusTheme === 'Live' ? '#F5F5F5E5' : '#71717A');

var img$j = "data:image/svg+xml,%3csvg width='23' height='23' viewBox='0 0 23 23' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cg clip-path='url(%23clip0_11578_40259)'%3e%3cpath d='M6.5 9.08984V13.0898' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M10.5 4.08984V18.0898' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M14.5 6.58984L14.5 15.5898' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M18.5 9.08984L18.5 13.0898' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3e%3c/g%3e%3cdefs%3e%3cclipPath id='clip0_11578_40259'%3e%3crect width='22' height='23' fill='white' transform='translate(0.5)'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e";

var img$i = "data:image/svg+xml,%3csvg width='20' height='21' viewBox='0 0 20 21' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M16.25 3.625H3.75C3.40482 3.625 3.125 3.90482 3.125 4.25V16.75C3.125 17.0952 3.40482 17.375 3.75 17.375H16.25C16.5952 17.375 16.875 17.0952 16.875 16.75V4.25C16.875 3.90482 16.5952 3.625 16.25 3.625Z' stroke='%238B5CF6' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M13.75 2.375V4.875' stroke='%238B5CF6' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M6.25 2.375V4.875' stroke='%238B5CF6' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M3.125 7.375H16.875' stroke='%238B5CF6' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3e%3c/svg%3e";
...
const SpaceBanner = ({
  ...
  if (!spaceData) {
    return jsxRuntime.jsx(SpaceBannerLoadingSkeleton, {});
  }

  return jsxRuntime.jsxs(Container$h, Object.assign({
    orientation: orientation,
    status: spaceStatus,
    theme: theme,
    onClick: handleClick,
    ...
    children: [orientation === 'maximized' && jsxRuntime.jsx(HostPfpContainer, {
    ...
    }), orientation === 'maximized' ? null : jsxRuntime.jsx(Icon, {
      src: spaceStatus === 'Live' ? img$j : spaceStatus === 'Scheduled' ? img$i : '' // Ended
      ,
      alt: "status"
    }), jsxRuntime.jsx(Title$2, Object.assign({
      orientation: orientation
    }, {
    ...
    })), jsxRuntime.jsxs(Status, Object.assign({
      orientation: orientation
    }, {
      children: [jsxRuntime.jsxs(Time, Object.assign({
        orientation: orientation
      }, {
        children: [jsxRuntime.jsx(Icon, {
          ...
          ,
          alt: "status"
        }), jsxRuntime.jsx(TimeText, Object.assign({
          status: spaceStatus
        }, {
      ...
      })), jsxRuntime.jsx(ParticipantContainer, {
        participants: spaceData === null || spaceData === void 0 ? void 0 : spaceData.pendingMembers,
        orientation: orientation
      })]
    })), isInvite === true && spaceStatus === 'Live' ? jsxRuntime.jsx(InviteButton, Object.assign({
      status: "Live",
      onClick: onJoin
    }, {
      children: "Join this space"
    })) : isInvite === true && spaceStatus === 'Scheduled' ? jsxRuntime.jsx(InviteButton, Object.assign({
      status: "Scheduled"
    }, {
      children: "Remind Me"
    })) : null]
...
const Time = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const VideoPlayer = ({
  ...
  const incomingVideoRef = React.useRef(null);
  React.useEffect(() => {
...
const Video = /*#__PURE__*/styled__default["default"].video.withConfig({
...
const LiveSpaceProfileContainer = options => {
  ...
  return jsxRuntime.jsxs(Item$1, Object.assign({
    display: 'flex',
    ...
    children: [jsxRuntime.jsx(Image$4, {
      ...
      width: '56px',
      borderRadius: '50%'
    }), jsxRuntime.jsxs(Text$1, Object.assign({
      fontSize: '17px',
      marginTop: '4px',
      fontWeight: 600
    }, {
      children: [wallet.slice(7, 12).concat('...'), stream && jsxRuntime.jsx(VideoPlayer, {
        videoCallData: stream
      })]
    })), requested ? jsxRuntime.jsxs(Item$1, Object.assign({
      display: 'flex',
      marginTop: '5px',
      fontWeight: 600,
      gap: '4px',
      ...
      children: [jsxRuntime.jsx(Text$1, Object.assign({
        fontSize: '12px',
        color: '#8B5CF6'
      }, {
        children: "Requested"
      })), jsxRuntime.jsx(Image$4, {
        src: img$h,
        alt: "Hand Icon",
        height: '15px',
        width: '15px'
      })]
    })) : jsxRuntime.jsxs(Item$1, Object.assign({
      display: 'flex',
      marginTop: '5px',
      fontWeight: 600,
      gap: '4px',
...
const ClickawayCloseModal = ({
  ...
  return jsxRuntime.jsx(ModalParent, Object.assign({
    ref: modalRef,
    width: width,
    theme: theme
  }, {
...
const Modal$2 = ({
  ...
  const theme = React.useContext(ThemeContext);
  return jsxRuntime.jsx(ModalOverlay, {
    children: clickawayClose ? jsxRuntime.jsx(ClickawayCloseModal, Object.assign({
      clickawayClose: clickawayClose,
      width: width
    }, {
      children: children
    })) : jsxRuntime.jsx(ModalParent, Object.assign({
      width: width,
      theme: theme
    }, {
      children: children
...
const ModalOverlay = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "Modal__ModalOverlay",
  componentId: "sc-1q8t9j6-0"
})(["position:fixed;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,0.4);display:flex;justify-content:center;align-items:center;"]);
const ModalParent = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const ModalHeader$1 = props => {
  return jsxRuntime.jsx("div", {
    children: jsxRuntime.jsxs(Header, {
      children: [props.backCallback ? jsxRuntime.jsx(BackBtn, Object.assign({
        onClick: props.backCallback
      }, {
        children: jsxRuntime.jsx(ArrowLeft, {})
      })) : null, jsxRuntime.jsxs(CenterText, {
        children: [props.heading, props.headingBadgeNumber && jsxRuntime.jsx(NumberBadge, {
          children: props.headingBadgeNumber
        })]
      }), props.closeCallback ? jsxRuntime.jsx(CloseBtn$1, Object.assign({
        onClick: props.closeCallback
      }, {
        children: jsxRuntime.jsx(CloseSvg, {})
      })) : null]
    })
  });
};
...
})(["display:flex;align-items:center;width:100%;margin-bottom:24px;"]);
const BackBtn = /*#__PURE__*/styled__default["default"].button.withConfig({
...
const CloseBtn$1 = /*#__PURE__*/styled__default["default"].button.withConfig({
...
const CenterText = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const NumberBadge = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "ModalHeader__NumberBadge",
  componentId: "sc-1ibnxvs-4"
})(["display:flex;justify-content:center;align-items:center;background:#8B5CF6;color:#fff;border-radius:8px;margin-left:8px;padding:4px 8px;font-size:13px;font-weight:500;}"]);
...
const ProfileContainer = ({
  ...
  return jsxRuntime.jsxs(ParentContainer, Object.assign({
    border: _border
  }, {
    children: [jsxRuntime.jsx(PfpContainer, {
      children: jsxRuntime.jsx(Pfp, {
        src: _imageUrl,
        alt: "host pfp",
        imageHeight: imageHeight
      })
    }), jsxRuntime.jsxs(HostContainer, {
      children: [jsxRuntime.jsxs(ProfileDetails, {
        children: [jsxRuntime.jsx(HostName, {
          children: jsxRuntime.jsx(Name, {
            children: _name
          })
        }), _handle && jsxRuntime.jsxs(HostHandle, Object.assign({
          theme: theme
        }, {
          children: ["@", _handle]
        }))]
      }), tag ? jsxRuntime.jsx(Host, {
        children: tag
      }) : null, contBtn ? jsxRuntime.jsx("div", Object.assign({
        onClick: btnCallback !== null && btnCallback !== void 0 ? btnCallback : handleDDState
      }, {
        children: contBtn
      })) : null]
    }), isDDOpen ? jsxRuntime.jsxs(DropDown, Object.assign({
      theme: theme,
      ref: dropdownRef,
      isDDOpen: isDDOpen
    }, {
      children: [jsxRuntime.jsx(DDItem, Object.assign({
        onClick: removeCallback
      }, {
        children: "Remove"
      })), promoteCallback ? jsxRuntime.jsx(DDItem, Object.assign({
...
const ParentContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "ProfileContainer__ParentContainer",
  componentId: "sc-ia68b0-0"
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;position:relative;padding:8px 16px;border:", ";border-radius:16px;"], props => props.border ? '1px solid #E4E4E7' : 'none');
const PfpContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "ProfileContainer__PfpContainer",
  componentId: "sc-ia68b0-1"
})(["display:flex;"]);
const Pfp = /*#__PURE__*/styled__default["default"].img.withConfig({
...
const HostContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const ProfileDetails = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const HostName = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "ProfileContainer__HostName",
  componentId: "sc-ia68b0-5"
})(["display:flex;flex-direction:row;font-weight:600;font-size:15px;width:100%;"]);
const Name = /*#__PURE__*/styled__default["default"].span.withConfig({
  displayName: "ProfileContainer__Name",
  componentId: "sc-ia68b0-6"
})(["text-overflow:ellipsis;white-space:nowrap;overflow:hidden;"]);
const Host = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "ProfileContainer__Host",
  componentId: "sc-ia68b0-7"
})(["display:flex;flex-direction:row;align-items:center;margin-left:8px;line-height:18px;width:max-content;background:rgba(139,92,246,0.2);color:#8B5CF6;border-radius:6px;font-weight:500;font-size:12px;padding:6px 10px;border-radius:8px;"]);
const HostHandle = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const DropDown = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const DDItem = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const fadeOut = /*#__PURE__*/styled.keyframes(["from{opacity:1;}to{opacity:0;visibility:hidden;}"]);

var img$f = "data:image/svg+xml,%3csvg width='36' height='40' viewBox='0 0 36 40' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M16 12C16 13.1046 16.8954 14 18 14C19.1046 14 20 13.1046 20 12C20 10.8954 19.1046 10 18 10C16.8954 10 16 10.8954 16 12Z' fill='black'/%3e%3cpath d='M16 20C16 21.1046 16.8954 22 18 22C19.1046 22 20 21.1046 20 20C20 18.8954 19.1046 18 18 18C16.8954 18 16 18.8954 16 20Z' fill='black'/%3e%3cpath d='M16 28C16 29.1046 16.8954 30 18 30C19.1046 30 20 29.1046 20 28C20 26.8954 19.1046 26 18 26C16.8954 26 16 26.8954 16 28Z' fill='black'/%3e%3c/svg%3e";

const tempImageUrl = "https://imgv3.fotor.com/images/blog-richtext-image/10-profile-picture-ideas-to-make-you-stand-out.jpg";

const Requests = () => {
  return jsxRuntime.jsxs(Container$j, {
    children: [jsxRuntime.jsx(ProfileContainer, {
      imageUrl: tempImageUrl,
      name: 'Dan',
      handle: 'red',
      imageHeight: '48px'
    }), jsxRuntime.jsx(ProfileContainer, {
      imageUrl: tempImageUrl,
      name: 'Abramov',
      handle: 'ux',
      imageHeight: '48px'
...
const Speakers = () => {
  return jsxRuntime.jsxs(Container$j, {
    children: [jsxRuntime.jsxs(ProfileWithSettingsContainer, {
      children: [jsxRuntime.jsx(ProfileContainer, {
        imageUrl: tempImageUrl,
        name: 'Dan',
        handle: 'red',
        imageHeight: '48px'
      }), jsxRuntime.jsx(SettingsIconContainer, {
        children: jsxRuntime.jsx(Image$4, {
          alt: "Settings icon",
          height: '40px',
          src: img$f
    ...
    }), jsxRuntime.jsxs(ProfileWithSettingsContainer, {
      children: [jsxRuntime.jsx(ProfileContainer, {
        imageUrl: tempImageUrl,
        name: 'Abramov',
        handle: 'ux',
...
const SpaceMembersSectionModal = ({
  ...
  const [activeTab, setActiveTab] = React.useState(MemberTabsEnum.CoHost);
  ...
  const renderTabs = () => {
    return Object.values(MemberTabsEnum).map(tab => jsxRuntime.jsx(Tab$1, Object.assign({
  ...
  return jsxRuntime.jsxs(Modal$2, Object.assign({
    clickawayClose: onClose,
    width: '380px'
  }, {
    children: [jsxRuntime.jsx(ModalHeader$1, {
      heading: 'Members',
      closeCallback: onClose
    }), jsxRuntime.jsxs(SpacesMembersContainer, {
      children: [jsxRuntime.jsx(ProfileContainer, {
        imageUrl: tempImageUrl,
        ...
        imageHeight: '48px',
        tag: 'Host'
      }), jsxRuntime.jsx(TabContainer, {
        children: renderTabs()
      }), activeTab === MemberTabsEnum.CoHost && jsxRuntime.jsx(CoHosts, {}), activeTab === MemberTabsEnum.Speakers && jsxRuntime.jsx(Speakers, {}), activeTab === MemberTabsEnum.Requests && jsxRuntime.jsx(Requests, {}), activeTab === MemberTabsEnum.Listeners && jsxRuntime.jsx(Listeners, {}), jsxRuntime.jsx(Button$6, Object.assign({
        padding: '16px',
        borderRadius: '8px',
        background: '#8B5CF6',
...
const SpacesMembersContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const ProfileWithSettingsContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceMembersSectionModal__ProfileWithSettingsContainer",
  componentId: "sc-1qevf22-1"
})(["display:flex;justify-content:space-between;"]);
const SettingsIconContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceMembersSectionModal__SettingsIconContainer",
  componentId: "sc-1qevf22-2"
})(["display:flex;margin:0px 16px;align-items:center;cursor:pointer;"]);
const TabContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceMembersSectionModal__TabContainer",
  componentId: "sc-1qevf22-3"
})(["display:flex;padding:0px 10px;"]);
const Tab$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const LiveWidgetContent = ({
  ...
  const handleJoinSpace = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isListener) {
      ...
      yield (_b = spacesObjectRef === null || spacesObjectRef === void 0 ? void 0 : spacesObjectRef.current) === null || _b === void 0 ? void 0 : _b.join();
  ...
  React.useEffect(() => {
    const createAudioStream = () => __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (isSpeaker) {
        ...
        yield spacesObjectRef.current.createAudioStream();
      }
    });
  ...
  React.useEffect(() => {
    ...
    if (!((_a = spaceObjectData === null || spaceObjectData === void 0 ? void 0 : spaceObjectData.connectionData) === null || _a === void 0 ? void 0 : _a.local.stream) || !isSpeaker) return;
  ...
  }, [(_a = spaceObjectData === null || spaceObjectData === void 0 ? void 0 : spaceObjectData.connectionData) === null || _a === void 0 ? void 0 : _a.local.stream]);
  React.useEffect(() => {
    if (!spaceObjectData.spaceDescription) return;
    const playBackUrl = spaceObjectData.spaceDescription;
    setPlayBackUrl(playBackUrl);
  }, [spaceObjectData.spaceDescription]); // console.log('spaceObjectData', spaceObjectData);
  // console.log('playBackUrl', playBackUrl);
  // console.log('isListener', isListener);

  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [jsxRuntime.jsxs(Item$1, Object.assign({
      flex: '1',
      display: 'flex',
      padding: '16px 10px',
      flexWrap: 'wrap',
      ...
      children: [isSpeaker && spaceObjectData.connectionData.incoming.map(profile => jsxRuntime.jsx(LiveSpaceProfileContainer, {
        isHost: isHost,
        isSpeaker: isSpeaker,
        wallet: profile.address,
        image: tempImageUrl,
        stream: profile.stream
      })), isListener && spaceObjectData.members.map(profile => jsxRuntime.jsx(LiveSpaceProfileContainer, {
        isHost: isHost,
        isSpeaker: isSpeaker,
      ...
      children: [isJoined ? jsxRuntime.jsxs(Item$1, Object.assign({
        borderRadius: '8px',
        background: '#EDE9FE',
        display: 'flex',
        ...
        children: [jsxRuntime.jsxs(Item$1, Object.assign({
          ...
          gap: '8px',
          padding: '10px',
          onClick: () => isHost || isSpeaker ? setIsMicOn(!isMicOn) : null
        }, {
          children: [jsxRuntime.jsx(Image$4, {
            width: '14px',
            height: '20px',
            src: isHost || isSpeaker ? isMicOn ? img$d : img$c : img$e,
            alt: "Mic Icon"
          }), jsxRuntime.jsx(Text$1, Object.assign({
            color: "#8B5CF6",
            fontSize: '14px',
            fontWeight: 600
          }, {
            children: isHost || isSpeaker ? isMicOn ? 'Speaking' : 'Muted' : 'Request'
          }))]
        })), jsxRuntime.jsxs(Item$1, Object.assign({
          display: 'flex',
          alignItems: 'center',
          ...
          children: [jsxRuntime.jsx(Image$4, {
            ...
            cursor: 'pointer',
            alt: "Share Icon"
          }), jsxRuntime.jsx(Button$6, Object.assign({
            color: "#8B5CF6",
            fontSize: '14px',
            fontWeight: 600,
            width: '100px',
        ...
        })), isListener && playBackUrl.length > 0 && jsxRuntime.jsx(PeerPlayer, {
          title: "spaceAudio",
...
var img$6 = "data:image/svg+xml,%3csvg width='26' height='26' viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M13 18C15.7614 18 18 15.7614 18 13C18 10.2386 15.7614 8 13 8C10.2386 8 8 10.2386 8 13C8 15.7614 10.2386 18 13 18Z' stroke='%2382828A' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M20 23C18.0988 24.2638 15.4538 25 13 25C10.6266 25 8.30655 24.2962 6.33316 22.9776C4.35977 21.6591 2.8217 19.7849 1.91345 17.5922C1.0052 15.3995 0.767559 12.9867 1.23058 10.6589C1.6936 8.33115 2.83649 6.19295 4.51472 4.51472C6.19295 2.83649 8.33115 1.6936 10.6589 1.23058C12.9867 0.767559 15.3995 1.0052 17.5922 1.91345C19.7849 2.8217 21.6591 4.35977 22.9776 6.33316C24.2962 8.30655 25 10.6266 25 13C25 15.7613 24 18 21.5 18C19 18 18 15.7613 18 13V8.00001' stroke='%2382828A' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/%3e%3c/svg%3e";
...
const ScheduledWidgetContent = ({
  ...
  const handleStartSpace = () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  React.useEffect(() => {
    function startSpace() {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!((_a = spaceObjectData === null || spaceObjectData === void 0 ? void 0 : spaceObjectData.connectionData) === null || _a === void 0 ? void 0 : _a.local.stream) || !isStarted) return;
        yield spacesObjectRef.current.start({
  ...
  return jsxRuntime.jsxs(Container$j, Object.assign({
    display: 'flex',
    height: '100%',
    alignItems: 'center',
    flexDirection: 'column',
    ...
    children: [jsxRuntime.jsx(Image$4, {
      ...
      children: jsxRuntime.jsx(Text$1, Object.assign({
        ...
        children: "Start this space"
      }))
    })), !isHost && !isMember && jsxRuntime.jsx(Button$6, Object.assign({
      padding: '9px 34px',
      borderRadius: '8px',
      background: '#8B5CF6',
      border: '1px solid #703BEB',
    ...
    })), (!isHost || isHost && !isTimeToStartSpace) && shareUrl && jsxRuntime.jsxs(Item$1, Object.assign({
      display: 'flex',
      gap: '13px'
    }, {
      children: [jsxRuntime.jsxs(ShareLinkItem, {
        children: [jsxRuntime.jsx(ShareLinkButton, Object.assign({
        ...
        children: [jsxRuntime.jsx(ShareLinkButton, {
          children: jsxRuntime.jsx(Image$4, {
            src: img$6,
            alt: "At Icon",
            width: '25px',
...
const SpaceInfoText = /*#__PURE__*/styled__default["default"].span.withConfig({
  displayName: "ScheduledWidgetContent__SpaceInfoText",
  componentId: "sc-13slgtw-0"
})(["font-size:18px;font-weight:600;text-align:center;"]);
const ShareLinkItem = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "ScheduledWidgetContent__ShareLinkItem",
  componentId: "sc-13slgtw-1"
})(["display:flex;flex-direction:column;gap:8px;align-items:center;"]);
const ShareLinkButton = /*#__PURE__*/styled__default["default"].button.withConfig({
  displayName: "ScheduledWidgetContent__ShareLinkButton",
  componentId: "sc-13slgtw-2"
})(["background:#e4e4e7;border-radius:14px;padding:16px;border:none;cursor:pointer;"]);
...
const WidgetContent = ({
  ...
  const [isSpaceLive, setIsSpaceLive] = React.useState(false);
  console.log('isSpaceLive', isSpaceLive);
  console.log('Rendering WidgetContent');
  React.useEffect(() => {
    setIsSpaceLive(isLive);
  }, [isLive]);
  return jsxRuntime.jsx(Container$g, Object.assign({
    isMinimized: isMinimized,
    height: isSpaceLive ? LIVE_WIDGET_CONTENT_FIXED_HEIGHT : SCHEDULED_WIDGET_CONTENT_FIXED_HEIGHT
  }, {
    children: isSpaceLive ? jsxRuntime.jsx(LiveWidgetContent, {
      spaceData: spaceData,
      isHost: isHost
    }) : jsxRuntime.jsx(ScheduledWidgetContent, {
      spaceData: spaceData,
      shareUrl: shareUrl,
      isHost: isHost,
      isMember: isMember,
...
const Container$g = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "WidgetContent__Container",
  componentId: "sc-13gsred-0"
})(["display:flex;flex-direction:column;border-bottom:", ";height:", ";transition:height 200ms ease-out;overflow:hidden;align-items:center;justify-content:space-between;"], props => props.theme.border, props => props.isMinimized ? '0' : props.height);

var img$5 = "data:image/svg+xml,%3csvg width='33' height='32' viewBox='0 0 33 32' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M26.5 10C27.6046 10 28.5 9.10457 28.5 8C28.5 6.89543 27.6046 6 26.5 6C25.3954 6 24.5 6.89543 24.5 8C24.5 9.10457 25.3954 10 26.5 10Z' fill='white'/%3e%3cpath d='M26.5 18C27.6046 18 28.5 17.1046 28.5 16C28.5 14.8954 27.6046 14 26.5 14C25.3954 14 24.5 14.8954 24.5 16C24.5 17.1046 25.3954 18 26.5 18Z' fill='white'/%3e%3cpath d='M26.5 26C27.6046 26 28.5 25.1046 28.5 24C28.5 22.8954 27.6046 22 26.5 22C25.3954 22 24.5 22.8954 24.5 24C24.5 25.1046 25.3954 26 26.5 26Z' fill='white'/%3e%3c/svg%3e";

var img$4 = "data:image/svg+xml,%3csvg width='33' height='32' viewBox='0 0 33 32' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M25.5113 13.272L25.5114 13.2721L25.5173 13.2656C25.6713 13.0939 25.7538 12.8686 25.7499 12.6375C25.7459 12.4064 25.6558 12.1841 25.4959 12.0179C25.3356 11.8515 25.1174 11.7544 24.8867 11.7501C24.6559 11.7459 24.4344 11.835 24.2683 11.9957L24.2682 11.9956L24.2621 12.0019L16.5 20.0625L8.73789 12.0019L8.738 12.0018L8.73166 11.9957C8.56563 11.835 8.34408 11.7459 8.11332 11.7501C7.88259 11.7544 7.6644 11.8515 7.50414 12.0179C7.34416 12.1841 7.25406 12.4064 7.25013 12.6375C7.24621 12.8686 7.32869 13.0939 7.48273 13.2656L7.48262 13.2657L7.48873 13.272L15.8754 21.9823L15.8755 21.9825C16.0395 22.1526 16.2639 22.25 16.5 22.25C16.7361 22.25 16.9605 22.1526 17.1245 21.9825L17.1246 21.9823L25.5113 13.272Z' fill='white' stroke='white' stroke-width='0.5'/%3e%3c/svg%3e";

var img$3 = "data:image/svg+xml,%3csvg width='33' height='32' viewBox='0 0 33 32' fill='none' xmlns='http://www.w3.org/2000/svg' transform='rotate(180)'%3e%3cpath d='M25.5113 13.272L25.5114 13.2721L25.5173 13.2656C25.6713 13.0939 25.7538 12.8686 25.7499 12.6375C25.7459 12.4064 25.6558 12.1841 25.4959 12.0179C25.3356 11.8515 25.1174 11.7544 24.8867 11.7501C24.6559 11.7459 24.4344 11.835 24.2683 11.9957L24.2682 11.9956L24.2621 12.0019L16.5 20.0625L8.73789 12.0019L8.738 12.0018L8.73166 11.9957C8.56563 11.835 8.34408 11.7459 8.11332 11.7501C7.88259 11.7544 7.6644 11.8515 7.50414 12.0179C7.34416 12.1841 7.25406 12.4064 7.25013 12.6375C7.24621 12.8686 7.32869 13.0939 7.48273 13.2656L7.48262 13.2657L7.48873 13.272L15.8754 21.9823L15.8755 21.9825C16.0395 22.1526 16.2639 22.25 16.5 22.25C16.7361 22.25 16.9605 22.1526 17.1245 21.9825L17.1246 21.9823L25.5113 13.272Z' fill='white' stroke='white' stroke-width='0.5'/%3e%3c/svg%3e";

var img$2 = "data:image/svg+xml,%3csvg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M16.25 3.125H3.75C3.40482 3.125 3.125 3.40482 3.125 3.75V16.25C3.125 16.5952 3.40482 16.875 3.75 16.875H16.25C16.5952 16.875 16.875 16.5952 16.875 16.25V3.75C16.875 3.40482 16.5952 3.125 16.25 3.125Z' stroke='white' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M13.75 1.875V4.375' stroke='white' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M6.25 1.875V4.375' stroke='white' stroke-linecap='round' stroke-linejoin='round'/%3e%3cpath d='M3.125 6.875H16.875' stroke='white' stroke-linecap='round' stroke-linejoin='round'/%3e%3c/svg%3e";
...
const Button$5 = props => {
  ...
  return jsxRuntime.jsx(SpacesButton, Object.assign({
    onClick: onClick,
    width: width,
    height: height,
    theme: theme,
...
const SpacesButton = /*#__PURE__*/styled__default["default"].button.withConfig({
...
var img$1 = "data:image/svg+xml,%3csvg width='33' height='32' viewBox='0 0 33 32' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M25.5113 13.272L25.5114 13.2721L25.5173 13.2656C25.6713 13.0939 25.7538 12.8686 25.7499 12.6375C25.7459 12.4064 25.6558 12.1841 25.4959 12.0179C25.3356 11.8515 25.1174 11.7544 24.8867 11.7501C24.6559 11.7459 24.4344 11.835 24.2683 11.9957L24.2682 11.9956L24.2621 12.0019L16.5 20.0625L8.73789 12.0019L8.738 12.0018L8.73166 11.9957C8.56563 11.835 8.34408 11.7459 8.11332 11.7501C7.88259 11.7544 7.6644 11.8515 7.50414 12.0179C7.34416 12.1841 7.25406 12.4064 7.25013 12.6375C7.24621 12.8686 7.32869 13.0939 7.48273 13.2656L7.48262 13.2657L7.48873 13.272L15.8754 21.9823L15.8755 21.9825C16.0395 22.1526 16.2639 22.25 16.5 22.25C16.7361 22.25 16.9605 22.1526 17.1245 21.9825L17.1246 21.9823L25.5113 13.272Z' fill='%2382828A' stroke='%2382828A' stroke-width='0.5'/%3e%3c/svg%3e";

var img = "data:image/svg+xml,%3csvg width='33' height='32' viewBox='0 0 33 32' fill='none' xmlns='http://www.w3.org/2000/svg' transform='rotate(180)'%3e%3cpath d='M25.5113 13.272L25.5114 13.2721L25.5173 13.2656C25.6713 13.0939 25.7538 12.8686 25.7499 12.6375C25.7459 12.4064 25.6558 12.1841 25.4959 12.0179C25.3356 11.8515 25.1174 11.7544 24.8867 11.7501C24.6559 11.7459 24.4344 11.835 24.2683 11.9957L24.2682 11.9956L24.2621 12.0019L16.5 20.0625L8.73789 12.0019L8.738 12.0018L8.73166 11.9957C8.56563 11.835 8.34408 11.7459 8.11332 11.7501C7.88259 11.7544 7.6644 11.8515 7.50414 12.0179C7.34416 12.1841 7.25406 12.4064 7.25013 12.6375C7.24621 12.8686 7.32869 13.0939 7.48273 13.2656L7.48262 13.2657L7.48873 13.272L15.8754 21.9823L15.8755 21.9825C16.0395 22.1526 16.2639 22.25 16.5 22.25C16.7361 22.25 16.9605 22.1526 17.1245 21.9825L17.1246 21.9823L25.5113 13.272Z' fill='%2382828A' stroke='%2382828A' stroke-width='0.5'/%3e%3c/svg%3e";
...
const Accordion = ({
  ...
  return jsxRuntime.jsxs(AccordionParent, {
    children: [jsxRuntime.jsxs(AccordionTitle, Object.assign({
      onClick: toggleAccordion
    }, {
      children: [jsxRuntime.jsxs(Title$1, {
        children: [jsxRuntime.jsx("div", {
          children: title
        }), items ? jsxRuntime.jsx(PendingCount$1, Object.assign({
          theme: theme
        }, {
          children: items
        })) : null]
      }), jsxRuntime.jsx(Image$3, {
        src: isOpen ? img : img$1,
        alt: "Maximize/Minimize icon"
      })]
    })), jsxRuntime.jsx(AccordionBody, Object.assign({
      isOpen: isOpen
    }, {
      children: children
    }))]
...
const AccordionParent = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const AccordionBody = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const AccordionTitle = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Title$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "Accordion__Title",
  componentId: "sc-13astz2-3"
})(["display:flex;align-items:center;"]);
const PendingCount$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const SpacesInfo = props => {
  ...
  return jsxRuntime.jsx(Modal$2, Object.assign({
    width: '400px'
  }, {
    children: jsxRuntime.jsxs(SpacesInfoContainer, {
      children: [jsxRuntime.jsx(ModalHeader$1, {
        heading: 'Spaces info',
        ...
        imageHeight: '48px',
        tag: 'Host'
      }), jsxRuntime.jsxs(SpacesDetailsContainer, {
        children: [jsxRuntime.jsx(Title, {
          children: "larryscruff's space"
        }), jsxRuntime.jsx(Description, Object.assign({
          theme: theme
        }, {
          children: "Ac orci quam cras in placerat. Sollicitudin tristique sed nisi proin duis."
        }))]
      }), jsxRuntime.jsx(Button$5, Object.assign({
        customStyle: customStyle
      }, {
        children: "Invite Members"
      })), jsxRuntime.jsx(Accordion, Object.assign({
        title: 'Pending Invites',
        items: TEMP_MEMBERS.length
      }, {
        children: TEMP_MEMBERS.map(item => {
          return jsxRuntime.jsx(ProfileContainer, {
            imageHeight: '48px',
            handle: item.handle,
            name: item.name,
            imageUrl: tempImageUrl
...
const SpacesInfoContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpacesInfo__SpacesInfoContainer",
  componentId: "sc-12pbtz1-0"
})(["color:black;"]);
const SpacesDetailsContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Description = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const WidgetHeader = ({
  ...
  const theme = React.useContext(ThemeContext); // const { isLive } = useSpaceData();

  const tempImageUrl = 'https://imgv3.fotor.com/images/blog-richtext-image/10-profile-picture-ideas-to-make-you-stand-out.jpg';
  const [isSpacesInfoVisible, setIsSpacesInfoVisible] = React.useState(false);
  ...
  return jsxRuntime.jsxs(Container$f, Object.assign({
    theme: theme
  }, {
    children: [!isLive && jsxRuntime.jsxs(Section$3, {
      children: [jsxRuntime.jsx(Item$1, Object.assign({
        marginBottom: '12px'
      }, {
        children: jsxRuntime.jsx(HostPfpContainer, {
          statusTheme: "Live",
        ...
        children: [isHost && jsxRuntime.jsx(Button$4, Object.assign({
          padding: "6.5px 16.5px"
        }, {
          children: "Edit space"
        })), jsxRuntime.jsx(Item$1, Object.assign({
          marginLeft: '8px',
          display: 'flex',
    ...
    })), isLive && jsxRuntime.jsxs(Section$3, Object.assign({
      marginTop: "12px"
    }, {
      children: [jsxRuntime.jsxs(Item$1, Object.assign({
        display: 'flex',
        ...
        children: jsxRuntime.jsx(Item$1, {
          children: jsxRuntime.jsx(ParticipantContainer, {
            participants: spaceData === null || spaceData === void 0 ? void 0 : spaceData.members,
            orientation: "maximized"
          })
        })
      }))]
    })), isSpacesInfoVisible ? jsxRuntime.jsx(SpacesInfo, {
      closeSpacesInfo: closeSpacesInfo
    }) : null]
  }));
}; //styles

const Container$f = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Section$3 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Button$4 = /*#__PURE__*/styled__default["default"].button.withConfig({
  displayName: "WidgetHeader__Button",
  componentId: "sc-1va1891-3"
})(["padding:", ";color:", ";margin-left:10px;background:rgba(255,255,255,0.2);border-radius:6px;border:none;cursor:pointer;"], props => {
  var _a;

  return (_a = props.padding) !== null && _a !== void 0 ? _a : '0px';
}, props => {
  var _a;

  return (_a = props.color) !== null && _a !== void 0 ? _a : 'inherit';
});

const isHostOfSpace = (account, spaceData) => {
  return account.toUpperCase() === (spaceData === null || spaceData === void 0 ? void 0 : spaceData.spaceCreator.slice(7).toUpperCase());
};
const isMemberOfSpace = (account, spaceData) => {
  const isMemberArr = spaceData === null || spaceData === void 0 ? void 0 : spaceData.members.filter(member => member.wallet.slice(7).toUpperCase() === account.toUpperCase());
...
const SpaceWidget = options => {
  ...
  const [widgetHidden, setWidgetHidden] = React.useState(!spaceId);
  const {
    account,
    spaceObjectData,
    initSpaceObject,
  ...
  const isLive = spaceData && (spaceData === null || spaceData === void 0 ? void 0 : spaceData.status) === 'ACTIVE' ? true : false; // console.log('isLiveInWidget', isLive)
  ...
  React.useEffect(() => {
    ...
    fetchData();
  }, [spaceId]); // To Be Implemented Later via Meta messages.
  // useEffect(() => {
  //   (async () => {
  //     if (!spaceData) {
  //       return;
  ...
  return jsxRuntime.jsxs(Container$e, Object.assign({
    ...
    children: [jsxRuntime.jsx(WidgetHeader, {
      onClose: onClose,
      isMinimized: isMinimized,
...
const Container$e = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceWidget__Container",
  componentId: "sc-1nlioj1-0"
})(["font-family:'Strawford';border-radius:12px;border:1px solid #dcdcdf;display:flex;flex-direction:column;width:", ";max-width:", ";min-width:320px;background:white;justify-content:flex-start;position:fixed;bottom:", "px;right:", "px;visibility:", ";opacity:", ";transition:opacity 0.3s ease;z-index:", ";overflow:hidden;"], props => props.width ? `${props.width}px` : 'auto', props => props.width ? `${props.width}px` : `${DEFAULT_MAXWIDTH}px`, props => props.bottomOffset, props => props.rightOffset, props => props.hidden ? 'hidden' : 'visible', props => props.hidden ? 0 : 1, props => {
  var _a;
...
const Spinner$2 = ({
  ...
  return jsxRuntime.jsx(SpinLoader$2, Object.assign({
    width: `${_size}px`
  }, {
    children: jsxRuntime.jsx(SpinnerSvg, {
      color: '#8B5CF6'
    })
  }));
}; //styles

const spinAnimation$2 = /*#__PURE__*/styled.keyframes(["from{transform:rotate(0deg);}to{transform:rotate(360deg);}"]);
const SpinLoader$2 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
(function (Tabs) {
  ...
  Tabs["HostedByYou"] = "Hosted by you";
})(Tabs || (Tabs = {}));
...
const SpaceFeed = ({
  orientation: _orientation = 'veritcal',
  height,
  width,
  sortingOrder: _sortingOrder = [Tabs.Popular, Tabs.ForYou, Tabs.HostedByYou],
  ...
  const [tab, setTab] = React.useState(_sortingOrder[0]);
  const [filterTab, setFilterTab] = React.useState(_filter);
  const {
    account,
    mySpaces,
    setMySpaces,
  ...
  const handleMySpacesFilter = spacesList => {
    if (tab === Tabs.HostedByYou) {
      return spacesList.filter(space => {
        ...
        return ((_a = space.spaceInformation) === null || _a === void 0 ? void 0 : _a.spaceCreator.slice(7).toUpperCase()) === (account === null || account === void 0 ? void 0 : account.toUpperCase());
      });
    }
  ...
  return jsxRuntime.jsx("div", {
    children: _orientation === OrientationEnums.Horizontal ? jsxRuntime.jsx(Spaces, Object.assign({
      orientation: _orientation
    }, {
      children: _orientation === OrientationEnums.Horizontal ? mySpaces && ((_b = mySpaces.apiData) === null || _b === void 0 ? void 0 : _b.map(space => {
        return jsxRuntime.jsx(SpaceBanner, {
      ...
      children: [jsxRuntime.jsx(Navigation, Object.assign({
        showTabs: _showTabs,
        width: width,
        showFilter: _showFilter
      }, {
        children: jsxRuntime.jsx(NavButtonWrapper, {
          children: _sortingOrder.map(tabName => {
            return jsxRuntime.jsx(NavButton, Object.assign({
              active: tab === tabName,
      ...
      })), jsxRuntime.jsxs(Filter, Object.assign({
        showFilter: _showFilter
      }, {
        children: [jsxRuntime.jsx(FilterButton, Object.assign({
          active: filterTab === FilterEnums.All,
          onClick: () => setFilterTab(FilterEnums.All)
        }, {
          children: "All"
        })), jsxRuntime.jsx(FilterButton, Object.assign({
      ...
      })), jsxRuntime.jsx(ScrollContainer$1, Object.assign({
        width: width,
        height: height,
        ref: listInnerRef,
        onScroll: onScroll
      }, {
        children: jsxRuntime.jsxs(Container$d, {
          children: [tab === Tabs.ForYou ? jsxRuntime.jsx(Spaces, Object.assign({
            orientation: _orientation
          }, {
            children: mySpaces.apiData && (handleFilterData(handleMySpacesFilter(mySpaces.apiData)).length === 0 ? jsxRuntime.jsxs(NoSpaces, {
              children: [jsxRuntime.jsx(SpacesIcon, {
                src: img$9
              }), jsxRuntime.jsx(NoSpacesTextV1, {
                children: "Join a space"
              }), jsxRuntime.jsx(NoSpacesTextV2, {
          ...
          })) : tab === Tabs.Popular ? jsxRuntime.jsxs(PopularSpaces, {
            children: [jsxRuntime.jsx(Text, {
              children: "Popular Spaces"
            }), popularSpaces && handleFilterData(popularSpaces.apiData).map(space => {
              return jsxRuntime.jsx(SpaceBanner, {
                spaceId: space.spaceId,
                orientation: "maximized",
                onBannerClick: onBannerClickHandler ? handleClick : undefined
          ...
          }) : jsxRuntime.jsx(Spaces, Object.assign({
            orientation: _orientation
          }, {
            children: mySpaces.apiData && (handleFilterData(handleMySpacesFilter(mySpaces.apiData)).length === 0 ? jsxRuntime.jsxs(NoSpaces, {
              children: [jsxRuntime.jsx(SpacesIcon, {
          ...
          })), loading && jsxRuntime.jsx(Spinner$2, {
            size: "40"
          })]
        })
      }))]
...
const ScrollContainer$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Container$d = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceFeed__Container",
  componentId: "sc-tm8f47-1"
})(["display:flex;flex-direction:column;align-items:center;background:#ffffff;border:1px solid #dcdcdf;border-radius:12px;padding:24px 32px;}"]);
const Navigation = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceFeed__Navigation",
  componentId: "sc-tm8f47-2"
})(["display:", ";flex-direction:row;justify-content:space-between;align-items:center;width:", ";border-bottom:1px solid #DCDCDF;margin-bottom:", ";}"], props => props.showTabs ? 'flex' : 'none', props => props.width ? `${props.width}px` : 'inherit', props => props.showFilter ? '0' : '27px');
const NavButtonWrapper = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceFeed__NavButtonWrapper",
  componentId: "sc-tm8f47-3"
})(["display:flex;flex-direction:row;justify-content:space-between;align-items:center;}"]);
const NavButton = /*#__PURE__*/styled__default["default"].button.withConfig({
  displayName: "SpaceFeed__NavButton",
  componentId: "sc-tm8f47-4"
})(["padding:10px 30px;font-weight:450;font-size:14px;border:none;border-bottom:", ";background:none;color:", ";&:hover{cursor:pointer;}}"], props => props.active ? '2px solid #8B5CF6' : 'none', props => props.active ? '#000000' : '#71717A');
const Spaces = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceFeed__Spaces",
  componentId: "sc-tm8f47-5"
})(["display:flex;flex-direction:", ";justify-content:flex-start;align-items:center;background:#ffffff;width:", ";height:auto;gap:16px;}"], props => props.orientation === 'horizontal' ? 'row' : 'column', props => props.orientation === 'horizontal' ? 'inherit' : '100%');
const PopularSpaces = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceFeed__PopularSpaces",
  componentId: "sc-tm8f47-6"
})(["display:flex;flex-direction:column;justify-content:space-between;align-items:center;background:#ffffff;width:100%;height:auto;gap:16px;}"]);
const Text = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceFeed__Text",
  componentId: "sc-tm8f47-7"
})(["width:100%;text-align:left;font-family:'Strawford';font-weight:450;font-size:18px;}"]);
const Filter = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceFeed__Filter",
  componentId: "sc-tm8f47-8"
})(["display:", ";flex-direction:row;justify-content:flex-start;align-items:center;background:#ffffff;width:100%;margin:22px 0;}"], props => props.showFilter ? 'flex' : 'none');
const FilterButton = /*#__PURE__*/styled__default["default"].button.withConfig({
  displayName: "SpaceFeed__FilterButton",
  componentId: "sc-tm8f47-9"
})(["display:inline-flex;height:30px;padding:0px 16px;justify-content:center;align-items:center;border-radius:99px;border:1px solid #C4B5FD;background:", ";color:", ";margin-right:8px;font-size:14px;&:hover{cursor:pointer;}}"], props => props.active ? '#8B5CF6' : '#EDE9FE', props => !props.active ? '#8B5CF6' : '#FFF');
const NoSpaces = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const SpacesIcon = /*#__PURE__*/styled__default["default"].img.withConfig({
  displayName: "SpaceFeed__SpacesIcon",
  componentId: "sc-tm8f47-11"
})(["width:36px;height:36px;}"]);
const NoSpacesTextV1 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceFeed__NoSpacesTextV1",
  componentId: "sc-tm8f47-12"
})(["font-family:'Strawford';font-weight:450;font-size:16px;color:#000;}"]);
const NoSpacesTextV2 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceFeed__NoSpacesTextV2",
  componentId: "sc-tm8f47-13"
})(["font-family:'Strawford';font-weight:450;color:#71717A;font-size:14px;}"]);
...
const SpaceInvites = ({
  ...
  const handleJoinSpace = space => __awaiter(void 0, void 0, void 0, function* () {
    var _e;

    yield initSpaceObject(space === null || space === void 0 ? void 0 : space.spaceId);

    if (isSpeaker) {
      // create audio stream
      yield spacesObjectRef.current.createAudioStream();
      spaceId = space === null || space === void 0 ? void 0 : space.spaceId; // temp
    }

    if (isListener) {
      yield (_e = spacesObjectRef === null || spacesObjectRef === void 0 ? void 0 : spacesObjectRef.current) === null || _e === void 0 ? void 0 : _e.join();
      const playBackUrl = spaceObjectData.spaceDescription;
      setPlayBackUrl(playBackUrl);
      handleCloseModal();
      setSpaceWidgetId(space === null || space === void 0 ? void 0 : space.spaceId);
      console.log('space joined');
    }
  });
  ...
  React.useEffect(() => {
    ...
    joinSpaceAsSpeaker(); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [(_b = spaceObjectData === null || spaceObjectData === void 0 ? void 0 : spaceObjectData.connectionData) === null || _b === void 0 ? void 0 : _b.local.stream]);
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [!children && jsxRuntime.jsx(Button$3, Object.assign({
      ...
      children: children
    })), modalOpen && jsxRuntime.jsxs(Modal$2, Object.assign({
      clickawayClose: handleCloseModal,
      width: "450px"
    }, {
      children: [jsxRuntime.jsx(ModalHeader$1, {
        heading: "Spaces Invites",
        headingBadgeNumber: ((_c = spaceRequests.apiData) === null || _c === void 0 ? void 0 : _c.length) > 0 ? (_d = spaceRequests.apiData) === null || _d === void 0 ? void 0 : _d.length : undefined,
        closeCallback: handleCloseModal
      }), jsxRuntime.jsx(ScrollContainer, Object.assign({
        ref: containerRef,
        onScroll: onScrollContainer
      }, {
        children: jsxRuntime.jsxs(InviteContainer, {
          ...
          }) : null, loading ? jsxRuntime.jsx(Spinner$2, {
            size: "40"
          }) : null]
        })
      }))]
...
const Button$3 = /*#__PURE__*/styled__default["default"].button.withConfig({
  displayName: "SpaceInvites__Button",
  componentId: "sc-hjjf1x-0"
})(["padding:8px 16px;background-color:#8b5cf6;color:#fff;border:none;border-radius:4px;cursor:pointer;"]);
const ScrollContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SpaceInvites__ScrollContainer",
  componentId: "sc-hjjf1x-1"
})(["max-height:400px;width:inherit;margin-top:24px;overflow-y:scroll;&::-webkit-scrollbar{margin-left:10px;width:8px;height:8px;}&::-webkit-scrollbar-thumb{-webkit-appearance:none;width:4px;height:auto;background:#8b5cf6;border-radius:99px;}"]);
const InviteContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const TextInputWithCounter = props => {
  ...
  return jsxRuntime.jsxs(InputContainer$1, {
    children: [jsxRuntime.jsxs(LabelContainer$1, {
      children: [jsxRuntime.jsx("label", {
        children: props.labelName
      }), jsxRuntime.jsxs(CharCounter, Object.assign({
        theme: theme
      }, {
        children: [props.inputValue.length, " / ", props.charCount]
      }))]
    }), jsxRuntime.jsx(Input$3, {
      theme: theme,
...
const InputContainer$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const LabelContainer$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "TextInput__LabelContainer",
  componentId: "sc-qbpum2-1"
})(["display:flex;justify-content:space-between;font-weight:500;"]);
const Input$3 = /*#__PURE__*/styled__default["default"].input.withConfig({
  displayName: "TextInput__Input",
  componentId: "sc-qbpum2-2"
})(["padding:16px;margin-top:12px;width:330px;background:#FFFFFF;border:1px solid ", ";box-shadow:-1px -1px 2px ", ",1px 1px 2px ", ";border-radius:12px;font-family:'Strawford';font-size:14px;"], props => props.theme.btnOutline, props => props.theme.btnOutline, props => props.theme.btnOutline);
const CharCounter = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const SCWCreateModal = props => {
  ...
  return jsxRuntime.jsxs(Modal$2, Object.assign({
    ...
    }), jsxRuntime.jsx(TextInputWithCounter, {
      labelName: 'Name',
      inputValue: nameValue,
      onInputChange: handleNameChange,
      charCount: 50
    }), isDescriptionEnabled ? jsxRuntime.jsx(TextInputWithCounter, {
      labelName: 'Description',
      inputValue: descriptionValue,
      onInputChange: handleDescriptionChange,
      charCount: 120
    }) : null, jsxRuntime.jsxs(ButtonContainer$1, {
      children: [jsxRuntime.jsx(Button$5, Object.assign({
        ...
        children: jsxRuntime.jsx(Button$5, Object.assign({
          ...
          children: jsxRuntime.jsx(CalendarPurple, {
            height: '20',
            width: '20'
          })
        }))
...
const ButtonContainer$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const DateTimePicker = props => {
  ...
  const [timeHumanReadable, setTimeHumanReadable] = React.useState(0);
  ...
  return jsxRuntime.jsxs(DateTimeCont, {
    children: [jsxRuntime.jsx("div", {
      children: "Select date and time"
    }), jsxRuntime.jsx(Input$2, {
      theme: theme,
      type: "date",
      value: propsDate.toISOString().split('T')[0],
      onChange: handleDateChange
    }), jsxRuntime.jsxs(TimeContainer, {
      ...
      })), jsxRuntime.jsxs(Select, Object.assign({
        theme: theme,
...
const DateTimeCont = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "DateTimePicker__DateTimeCont",
  componentId: "sc-a5tvc-0"
})(["display:flex;flex-direction:column;margin-top:24px;"]);
const Input$2 = /*#__PURE__*/styled__default["default"].input.withConfig({
  displayName: "DateTimePicker__Input",
  componentId: "sc-a5tvc-1"
})(["padding:16px;margin-top:12px;width:330px;background:#FFFFFF;border:1px solid ", ";box-shadow:-1px -1px 2px ", ",1px 1px 2px ", ";border-radius:12px;font-size:16px;font-family:'Strawford';"], props => props.theme.btnOutline, props => props.theme.btnOutline, props => props.theme.btnOutline);
const TimeContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "DateTimePicker__TimeContainer",
  componentId: "sc-a5tvc-2"
})(["display:flex;width:100%;gap:12px;"]);
const Select = /*#__PURE__*/styled__default["default"].select.withConfig({
  displayName: "DateTimePicker__Select",
  componentId: "sc-a5tvc-3"
})(["padding:16px;margin-top:12px;background:#FFFFFF;border:1px solid ", ";box-shadow:-1px -1px 2px ", ",1px 1px 2px ", ";border-radius:12px;font-size:16px;font-family:'Strawford';width:", ";"], props => props.theme.btnOutline, props => props.theme.btnOutline, props => props.theme.btnOutline, props => props.width ? props.width : '100%');
...
const SearchInput = props => {
  ...
  return jsxRuntime.jsxs(InputContainer, {
    children: [jsxRuntime.jsx(LabelContainer, {
      children: jsxRuntime.jsx("label", {
        children: props.labelName
      })
    }), jsxRuntime.jsxs(InputWrapper, {
      children: [jsxRuntime.jsx(Input$1, {
        theme: theme,
        value: props.inputValue,
        onChange: handleChange,
        placeholder: 'Search...'
      }), jsxRuntime.jsx(CloseBtn, Object.assign({
...
const LabelContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SearchInput__LabelContainer",
  componentId: "sc-1f35nbe-1"
})(["display:flex;justify-content:space-between;font-weight:500;"]);
const Input$1 = /*#__PURE__*/styled__default["default"].input.withConfig({
  displayName: "SearchInput__Input",
  componentId: "sc-1f35nbe-2"
})(["padding:16px;margin-top:12px;width:330px;background:#FFFFFF;border:1px solid ", ";box-shadow:-1px -1px 2px ", ",1px 1px 2px ", ";border-radius:12px;"], props => props.theme.btnOutline, props => props.theme.btnOutline, props => props.theme.btnOutline);
...
const CloseBtn = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const SCWInviteModal = props => {
  ...
  const [invitedMember, setInvitedMember] = React.useState('');
  ...
  const searchMember = event => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const response = yield PushAPI__namespace.user.get({
  ...
  const handlePromoteToAdmin = user => {
    ...
    if (user.did) {
      ...
      const updateAddressArray = invitedAddressList.filter(item => item !== user.walletAddress);
      setInvitedAddressList(updateAddressArray);
    }
  ...
  const handleDeleteInvitedAdmin = user => {
    ...
    if (user.did) {
      ...
      const updateAddressArray = adminsAddressList.filter(item => item !== user.walletAddress);
      setAdminsAddressList(updateAddressArray);
    }
  };
  return jsxRuntime.jsx("div", {
    children: jsxRuntime.jsxs(Modal$2, Object.assign({
      clickawayClose: onClose
    }, {
      children: [jsxRuntime.jsx(ModalHeader$1, {
      ...
      }), jsxRuntime.jsx(SearchInput, {
        labelName: 'Add users',
        inputValue: invitedMember,
        onInputChange: searchMember,
        clearInput: clearInput
      }), jsxRuntime.jsx(ErrorMessage, {
        children: errorMsg
      }), jsxRuntime.jsxs(MembersList, {
        children: [loadingAccount && jsxRuntime.jsx(Spinner$2, {}), Object.keys(searchedUser).length === 0 ? null : searchedUser.hasOwnProperty('walletAddress') ? jsxRuntime.jsx(ProfileContainer, {
          imageHeight: '48px',
          handle: searchedUser.walletAddress,
          // handle='test'
          name: searchedUser.name,
          imageUrl: searchedUser.image,
          contBtn: jsxRuntime.jsx(ContBtn, {
            children: "Add +"
          }),
      ...
      }), invitedMembersList.length ? jsxRuntime.jsxs(InvitedList, {
        children: [jsxRuntime.jsxs(Heading, {
          children: ["Invited Members ", jsxRuntime.jsx(PendingCount, Object.assign({
            theme: theme
          }, {
          ...
          if (item.hasOwnProperty('walletAddress')) {
            return jsxRuntime.jsx(ProfileContainer, {
              ...
              name: item.name,
              imageUrl: item.image,
              contBtn: jsxRuntime.jsx(SettingsCont, {
                children: jsxRuntime.jsx(Image$4, {
                  alt: "Settings icon",
                  height: '40px',
                  src: img$f
      ...
      }) : null, adminsList.length ? jsxRuntime.jsxs(InvitedList, {
        children: [jsxRuntime.jsxs(Heading, {
          children: ["Speakers ", jsxRuntime.jsx(PendingCount, Object.assign({
            theme: theme
          }, {
      ...
      }) : null, jsxRuntime.jsx(Button$5, Object.assign({
        onClick: createSpace,
        width: 'max-content'
      }, {
        children: isLoading ? jsxRuntime.jsx(CircularProgressSpinner$1, {}) : 'Create Space'
      }))]
    }))
  });
};
const MembersList = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SCWInviteModal__MembersList",
  componentId: "sc-1kkr9mx-0"
})(["width:100%;display:flex;flex-direction:column;gap:8px;"]);
const InvitedList = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Heading = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SCWInviteModal__Heading",
  componentId: "sc-1kkr9mx-2"
})(["display:flex;align-items:center;"]);
const PendingCount = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SCWInviteModal__PendingCount",
  componentId: "sc-1kkr9mx-3"
})(["background:", ";border-radius:8px;padding:4px 10px;margin-left:6px;font-size:13px;color:", ";"], props => props.theme.btnColorPrimary, props => props.theme.titleTextColor);
const SettingsCont = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "SCWInviteModal__SettingsCont",
  componentId: "sc-1kkr9mx-4"
})(["display:flex;justify-content:center;align-items:center;cursor:pointer;"]);
const ContBtn = /*#__PURE__*/styled__default["default"].button.withConfig({
  displayName: "SCWInviteModal__ContBtn",
  componentId: "sc-1kkr9mx-5"
})(["display:flex;flex-direction:row;align-items:center;margin-left:8px;line-height:18px;width:max-content;background:transparent;color:#8B5CF6;border-radius:6px;font-weight:500;font-size:12px;padding:4px 8px;border-radius:8px;border:1px solid #8B5CF6;cursor:pointer;"]);
const ErrorMessage = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const SCWButton = props => {
  ...
  const theme = React.useContext(ThemeContext);
  return jsxRuntime.jsx("div", {
    children: jsxRuntime.jsx(CreateButton, Object.assign({
      customStyle: customStyle,
      theme: theme,
      onClick: onCreate
    }, {
...
const CreateButton = /*#__PURE__*/styled__default["default"].button.withConfig({
  displayName: "SCWButton__CreateButton",
  componentId: "sc-npo33l-0"
})(["padding:", ";border-radius:", ";border:", ";font-size:", ";background-image:", ";color:", ";cursor:pointer;"], props => props.customStyle.padding, props => props.customStyle.borderRadius, props => props.customStyle.border, props => props.customStyle.fontSize, props => props.theme.titleBg, props => props.theme.titleTextColor);
...
const SpaceCreationWidget = props => {
  ...
  const [invitedMembersList, setInvitedMembersList] = React.useState([]);
  const [invitedAddressList, setInvitedAddressList] = React.useState([]);
  const [adminsList, setAdminsList] = React.useState([]);
  const [adminsAddressList, setAdminsAddressList] = React.useState([]);
  ...
  const testCreateSpace = () => __awaiter(void 0, void 0, void 0, function* () {
    const spaceCreate = {
    ...
    try {
      setLoading(true);
      const response = yield PushAPI__namespace.space.create(spaceCreate);
  ...
  return jsxRuntime.jsxs(SCWContainer, {
    children: [CustomComponent ? jsxRuntime.jsx(CustomComponent, {}) : jsxRuntime.jsx(SCWButton, {
      onCreate: showCreateSpace
    }), isCreateModalVisible && jsxRuntime.jsx(SCWCreateModal, {
    ...
    }), isScheduleModalVisible && jsxRuntime.jsx(SCWScheduleModal, {
    ...
    }), isInviteModalVisible && jsxRuntime.jsx(SCWInviteModal, {
...
const SCWContainer = /*#__PURE__*/styled__default["default"].div.withConfig({
...
class SpacesUI {
  constructor(props) {
    this.SpaceBanner = options => {
      ...
      return jsxRuntime.jsx(SpaceBanner, Object.assign({}, options));
    };
    ...
    this.SpaceWidget = options => {
      ...
      const [SpaceId, setSpaceId] = React.useState(spaceId);
      React.useEffect(() => {
        setSpaceId(spaceId);
      }, [spaceId, setSpaceId]);
      React.useEffect(() => {
      ...
      return jsxRuntime.jsx(SpaceWidget, Object.assign({}, options, {
        spaceId: SpaceId
      }));
    };

    this.SpaceFeed = options => {
      return jsxRuntime.jsx(SpaceFeed, Object.assign({}, options));
    };

    this.SpaceInvites = options => {
      return jsxRuntime.jsx(SpaceInvites, Object.assign({}, options));
    };

    this.SpaceCreationButtonWidget = () => {
      return jsxRuntime.jsx(SpaceCreationWidget, {});
    };
...
const Spinner$1 = ({
  ...
  const {
    theme
  } = React.useContext(SupportChatPropsContext);
  return jsxRuntime.jsx(SpinLoader$1, Object.assign({
    width: `${_size}px`
  }, {
    children: jsxRuntime.jsx(SpinnerSvg, {
...
const spinAnimation$1 = /*#__PURE__*/styled.keyframes(["from{transform:rotate(0deg);}to{transform:rotate(360deg);}"]);
const SpinLoader$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "Spinner__SpinLoader",
...
const ChatInput = () => {
  ...
  const {
    ...
    chats,
    setChatsSorted
  } = React.useContext(SupportChatMainStateContext);
  ...
  return jsxRuntime.jsx(Container$c, Object.assign({
    theme: theme
  }, {
    children: messageBeingSent ? jsxRuntime.jsx(ItemHV2, {
      ...
      children: [jsxRuntime.jsx(TextInput, {
        ...
        children: [jsxRuntime.jsx("label", {}), filesUploading || loading ? jsxRuntime.jsx(Spinner$1, {
          size: "35"
        }) : jsxRuntime.jsx("div", Object.assign({
          onClick: handleSubmit
        }, {
          children: jsxRuntime.jsx(SendIconSvg, {
...
const Container$c = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const ModalHeader = () => {
  ...
  return jsxRuntime.jsxs(Container$b, Object.assign({
    theme: theme
  }, {
    children: [jsxRuntime.jsx(Span$4, Object.assign({
      theme: theme
    }, {
      children: modalTitle
    })), jsxRuntime.jsx(Section$2, Object.assign({
      onClick: () => handleOnChatIconClick({
        isModalOpen,
        setIsModalOpen
      })
    }, {
      children: jsxRuntime.jsx(Div$1, {
        children: jsxRuntime.jsx(MinimizeIcon, {})
      })
    }))]
  }));
}; //styles

const Container$b = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Section$2 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "ModalHeader__Section",
  componentId: "sc-yjqrej-1"
})(["padding:10px 5px;cursor:pointer;"]);
const Div$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Span$4 = /*#__PURE__*/styled__default["default"].span.withConfig({
...
const AddressInfo = () => {
  ...
  return jsxRuntime.jsxs(Container$a, Object.assign({
    theme: theme
  }, {
    children: [jsxRuntime.jsxs(Section$1, {
      children: [jsxRuntime.jsx(ImgSpan, {
        children: jsxRuntime.jsx(Image$1, {
...
const Container$a = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Section$1 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "AddressInfo__Section",
  componentId: "sc-f3zheg-1"
})(["display:flex;"]);
const ImgSpan = /*#__PURE__*/styled__default["default"].span.withConfig({
...
const Span$3 = /*#__PURE__*/styled__default["default"].span.withConfig({
...
const Chats = ({
  ...
  return jsxRuntime.jsx(Container$9, {
    children: jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: msg.messageType === 'Text' ? jsxRuntime.jsx(jsxRuntime.Fragment, {
        children: msg.fromCAIP10 === caip10 ? jsxRuntime.jsx(MessageWrapper, Object.assign({
          ...
          children: jsxRuntime.jsxs(SenderMessage, Object.assign({
            theme: theme
          }, {
            children: [jsxRuntime.jsx(TextMessage, {
              children: msg.messageContent
            }), msg.timestamp !== undefined && jsxRuntime.jsx(TimeStamp, {
              children: date
            })]
          }))
          ...
          children: jsxRuntime.jsxs(ReceivedMessage, Object.assign({
            theme: theme
          }, {
            children: [(msg === null || msg === void 0 ? void 0 : msg.icon) && msg.icon, jsxRuntime.jsx(TextMessage, {
              children: msg.messageContent
            }), msg.timestamp !== undefined && jsxRuntime.jsx(TimeStamp, {
              children: date
            })]
...
const Container$9 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Toaster = ({
  ...
  return jsxRuntime.jsxs(Container$8, Object.assign({
    ...
    children: [type === 'error' && jsxRuntime.jsx(ErrorSvg, {}), jsxRuntime.jsx(Span$2, {
      children: message
    }), jsxRuntime.jsx("div", Object.assign({
      onClick: () => onClose()
    }, {
...
const Container$8 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "Toaster__Container",
  componentId: "sc-1vzs537-0"
})(["display:flex;box-sizing:border-box;justify-content:space-between;", " box-shadow:0px 0px 10px rgba(0,0,0,0.1);border-radius:16px;padding:13px;margin-bottom:6px;"], props => props.type === 'error' && styled.css(["background:linear-gradient( 90.15deg,#ff2070 -125.65%,#ff2d79 -125.63%,#fff9fb 42.81% );"]));
...
const Div = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "sharedStyling__Div",
  componentId: "sc-lhr0ta-3"
})(["height:", ";width:", ";margin:", ";cursor:", ";align-self:", ";"], props => props.height || 'auto', props => props.width || '100%', props => props.margin || '0px', props => props.cursor || 'default', props => props.alignSelf || 'center');

const chatsFetchedLimit = 10;
const Modal$1 = () => {
  const [loading, setLoading] = React.useState(false);
  const [lastThreadHashFetched, setLastThreadHashFetched] = React.useState(null);
  const [wasLastListPresent, setWasLastListPresent] = React.useState(false);
  const {
    supportAddress,
    env,
    account,
  ...
  const greetingMsgObject = {
    ...
    link: null,
    timestamp: undefined,
    icon: jsxRuntime.jsx(HandWaveSvg, {
      fill: theme.btnColorPrimary
    })
  };
  ...
  const getUpdatedChats = message => __awaiter(void 0, void 0, void 0, function* () {
    if (message && supportAddress === pCAIP10ToWallet(message === null || message === void 0 ? void 0 : message.fromCAIP10)) {
      const chat = yield decryptChat({
        message,
        connectedUser,
        env
      });
  ...
  return jsxRuntime.jsxs(Container$7, Object.assign({
    ...
    }), !connectedUser && jsxRuntime.jsx(Chats, {
      msg: greetingMsgObject,
      caip10: walletToPCAIP10(account),
      messageBeingSent: true
    }), loading && jsxRuntime.jsx(Spinner$1, {
      size: "40"
    }), jsxRuntime.jsx(ChatSection, Object.assign({
      ref: listInnerRef,
      onScroll: onScroll,
      theme: theme
    }, {
      children: connectedUser && chats.length ? chats.map((chat, index) => jsxRuntime.jsx(Chats, {
        msg: chat,
        caip10: walletToPCAIP10(account),
        messageBeingSent: true
      }, index)) : jsxRuntime.jsx(jsxRuntime.Fragment, {})
    })), !connectedUser && !loading && jsxRuntime.jsxs(ConnectSection, {
      children: [jsxRuntime.jsx(Button$2, Object.assign({
        onClick: () => connectUser(),
        theme: theme
      }, {
        children: "Connect"
    ...
    }), toastMessage && jsxRuntime.jsx(Toaster, {
      message: toastMessage,
      type: toastType
    }), jsxRuntime.jsxs(InputSection, {
      children: [connectedUser && jsxRuntime.jsx(ChatInput, {}), jsxRuntime.jsx(Div, Object.assign({
        height: "18px",
        width: "145px"
      }, {
        children: jsxRuntime.jsx(SponserPushIcon, {})
      }))]
    })]
  }));
}; //styles

const Container$7 = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Button$2 = /*#__PURE__*/styled__default["default"].button.withConfig({
...
const Chat = ({
  ...
  return jsxRuntime.jsx(Container$6, {
    children: jsxRuntime.jsx(SupportChatPropsContext.Provider, Object.assign({
      value: chatPropsData
    }, {
      children: jsxRuntime.jsxs(SupportChatMainStateContext.Provider, Object.assign({
        value: chatMainStateData
      }, {
        children: [!isModalOpen && jsxRuntime.jsx(Button$1, Object.assign({
        ...
        })), isModalOpen && jsxRuntime.jsx(Modal$1, {})]
      }))
    }))
  });
}; //styles
...
const Container$6 = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "supportChat__Container",
  componentId: "sc-1p259ql-0"
...
const Button$1 = /*#__PURE__*/styled__default["default"].button.withConfig({
  displayName: "supportChat__Button",
  componentId: "sc-1p259ql-1"
...
const Spinner = ({
  ...
  return jsxRuntime.jsx(SpinLoader, Object.assign({
    width: `${_size}px`
  }, {
    children: jsxRuntime.jsx(SpinnerSvg, {
      color: _color
...
const spinAnimation = /*#__PURE__*/styled.keyframes(["from{transform:rotate(0deg);}to{transform:rotate(360deg);}"]);
const SpinLoader = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "Spinner__SpinLoader",
...
const Tooltip = ({
  ...
  return jsxRuntime.jsxs(TooltipWrapper // When to show the tooltip
  , Object.assign({
    // When to show the tooltip
    onMouseEnter: showTip,
    onMouseLeave: hideTip
  }, {
    children: [children, active && jsxRuntime.jsx(TooltipContent, Object.assign({
...
const TooltipWrapper = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "Tooltip__TooltipWrapper",
  componentId: "sc-ksqm3c-0"
})(["display:inline-block;position:relative;z-index:1;"]);
/* Absolute positioning */

const TooltipContent = /*#__PURE__*/styled__default["default"].div.withConfig({
...
const Message = ({
  ...
  return messageType === 'Text' ? jsxRuntime.jsx(Span$1, Object.assign({
    textAlign: "left",
    fontWeight: "400",
    fontSize: "16px",
    color: "#62626A",
  ...
  })) : messageType === 'Image' ? jsxRuntime.jsxs(Span$1, Object.assign({
    textAlign: "left",
    fontWeight: "400",
    fontSize: "16px",
    color: "#62626A",
  ...
  })) : messageType === 'File' ? jsxRuntime.jsxs(Span$1, Object.assign({
    textAlign: "left",
    fontWeight: "400",
    fontSize: "16px",
    color: "#62626A",
  ...
  })) : messageType === 'GIF' || messageType === 'MediaEmbed' ? jsxRuntime.jsxs(Span$1, Object.assign({
    textAlign: "left",
    fontWeight: "400",
    fontSize: "16px",
    color: "#62626A",
...
const ChatSnap = ({
  ...
  const checksumWallet = walletLowercase ? ethers.ethers.utils.getAddress(walletLowercase) : null;
  ...
  return jsxRuntime.jsxs(Container$5, Object.assign({
    ...
    children: [jsxRuntime.jsx(Image, {
      ...
      children: [jsxRuntime.jsxs(Section, Object.assign({
        ...
        children: [jsxRuntime.jsx(NameSpan, Object.assign({
          fontWeight: "700",
          color: "#000",
          cursor: "pointer"
        }, {
        ...
        })), open && jsxRuntime.jsx(Span$1, Object.assign({
          fontWeight: "400",
          fontSize: "12px",
          color: "#62626A",
          cursor: "pointer"
        ...
        }), open && checkIfUnread(id, chat) && jsxRuntime.jsx(UnreadChats //  numberOfUnreadMessages="3"
        , {})]
      }))]
    }))]
  }));
...
const Container$5 = /*#__PURE__*/styled__default["default"](Section).withConfig({
  displayName: "ChatSnap__Container",
  componentId: "sc-r4kigr-0"
})(["border-bottom:", ";cursor:", ";", ";"], props => props.active && '1px dashed #ededee', props => props.active && 'pointer', props => props.active && styled.css(["&:hover{background:#f4f5fa;border-radius:10px;}"]));
const NameSpan = /*#__PURE__*/styled__default["default"](Span$1).withConfig({
...
const MessageBoxHeader = () => {
  ...
  const {
    ...
    setActiveSubTab,
    activeSubTab
  } = React.useContext(ChatAndNotificationMainContext);
  const {
    selectedChatId,
    chatsFeed,
    requestsFeed,
  ...
  return selectedChat ? jsxRuntime.jsxs(Section, Object.assign({
    gap: "12px",
    padding: '23px 2px'
  }, {
    children: [jsxRuntime.jsx(Div, Object.assign({
      ...
      children: jsxRuntime.jsx(BackIcon, {})
    })), jsxRuntime.jsxs(Section, Object.assign({
      gap: "8px"
    }, {
      children: [jsxRuntime.jsx(Image, {
...
const SubTabHeader = () => {
  ...
  return jsxRuntime.jsxs(Section, Object.assign({
    ...
    children: [jsxRuntime.jsx(Div, Object.assign({
      ...
      children: jsxRuntime.jsx(BackIcon, {})
    })), jsxRuntime.jsx(Span$1, Object.assign({
      fontWeight: "700",
      fontSize: "16px"
    }, {
...
const MinimisedModalHeader = ({
  ...
  const SnapMessageHeader = () => {
    const selectedChat = chatsFeed[selectedChatId] || requestsFeed[selectedChatId] || (Object.keys(searchedChats || {}).length ? searchedChats[selectedChatId] : null);
    return jsxRuntime.jsx(ChatSnap, {
      chat: selectedChat,
      id: selectedChatId,
      modalOpen: modalOpen
    });
  ...
  return jsxRuntime.jsxs(Container$4, Object.assign({
    ...
    children: [selectedChatId && !!(Object.keys(chatsFeed || {}).length || Object.keys(requestsFeed || {}).length || Object.keys(searchedChats || {}).length) && modalOpen && jsxRuntime.jsx(MessageBoxHeader, {}), selectedChatId && !modalOpen && jsxRuntime.jsx(SnapMessageHeader, {}), !selectedChatId && modalOpen && activeSubTab && jsxRuntime.jsx(SubTabHeader, {}), (!selectedChatId && modalOpen && !activeSubTab || !modalOpen && !selectedChatId) && jsxRuntime.jsx(Section, Object.assign({
      gap: "4px"
    }, {
      children: jsxRuntime.jsx(Span$1, Object.assign({
        fontWeight: "700",
        fontSize: "18px",
        padding: '24px 2px',
      ...
      children: [(!selectedChatId && modalOpen && !activeSubTab && !newChat || !modalOpen && !selectedChatId) && jsxRuntime.jsx(Div, Object.assign({
        width: "20px",
        height: "20px",
        cursor: "pointer",
        onClick: () => {
        ...
        children: jsxRuntime.jsx(NewChatIcon, {})
      })), jsxRuntime.jsx(Div, Object.assign({
        width: "12px",
        height: "13.4px",
        cursor: "pointer",
        ...
        children: modalOpen ? jsxRuntime.jsx(MinimizeIcon, {}) : jsxRuntime.jsx(MaximizeIcon, {})
      }))]
    }))]
  }));
}; //styles

const Container$4 = /*#__PURE__*/styled__default["default"](Section).withConfig({
...
const EmojiIcon = () => {
  return jsxRuntime.jsxs("svg", Object.assign({
    ...
    children: [jsxRuntime.jsx("path", {
      ...
      d: "M6.5 9.5C7.32843 9.5 8 8.82843 8 8C8 7.17157 7.32843 6.5 6.5 6.5C5.67157 6.5 5 7.17157 5 8C5 8.82843 5.67157 9.5 6.5 9.5Z",
      fill: "#62626A"
    }), jsxRuntime.jsx("path", {
      d: "M10 16.5C12.28 16.5 14.22 14.84 15 12.5H5C5.78 14.84 7.72 16.5 10 16.5Z",
      fill: "#62626A"
    }), jsxRuntime.jsx("path", {
      d: "M9.99 0.5C4.47 0.5 0 4.98 0 10.5C0 16.02 4.47 20.5 9.99 20.5C15.52 20.5 20 16.02 20 10.5C20 4.98 15.52 0.5 9.99 0.5ZM10 18.5C5.58 18.5 2 14.92 2 10.5C2 6.08 5.58 2.5 10 2.5C14.42 2.5 18 6.08 18 10.5C18 14.92 14.42 18.5 10 18.5Z",
      fill: "#62626A"
    })]
  }));
};
...
const Typebar = ({
  ...
  const modalRef = React.useRef(null);
  const fileUploadInputRef = React__default["default"].useRef(null);
  const {
    selectedChatId,
    chatsFeed,
    setSearchedChats,
  ...
  return jsxRuntime.jsx(Container$3, {
    children: jsxRuntime.jsxs(TypebarSection, Object.assign({
      borderColor: "#DDDDDF",
      borderStyle: "solid",
      borderWidth: "1px",
      borderRadius: "8px",
      ...
      children: [jsxRuntime.jsxs(Section, Object.assign({
        ...
        children: [jsxRuntime.jsx(Div, Object.assign({
          ...
          children: jsxRuntime.jsx(EmojiIcon, {})
        })), showEmojis && jsxRuntime.jsx(Section, Object.assign({
          ref: modalRef,
          position: "absolute",
          bottom: "3.5rem",
          left: "3.5rem"
        }, {
          children: jsxRuntime.jsx(EmojiPicker__default["default"], {
            onEmojiClick: addEmoji,
            width: isMobile ? 260 : 320,
            height: 370
          })
        })), jsxRuntime.jsx(MultiLineInput, {
          onKeyDown: event => {
        ...
        children: [jsxRuntime.jsx(Section, Object.assign({
          ...
          children: jsxRuntime.jsx(GifIcon, {})
        })), gifOpen && jsxRuntime.jsx(Section, Object.assign({
          position: "absolute",
          bottom: "3.5rem",
          right: isMobile ? '5rem' : '8rem',
          ref: modalRef
        }, {
          children: jsxRuntime.jsx(GifPicker__default["default"], {
            onGifClick: sendGIF,
            width: isMobile ? 260 : 320,
            height: 370,
          ...
          children: !filesUploading && jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [jsxRuntime.jsx(Section, Object.assign({
              width: "17px",
              height: "24px",
              cursor: "pointer",
              ...
              children: jsxRuntime.jsx(AttachmentIcon, {})
            })), jsxRuntime.jsx(FileInput, {
              type: "file",
              ref: fileUploadInputRef,
              onChange: e => uploadFile(e)
            })]
          })
        })), !(loading || filesUploading) && jsxRuntime.jsx(Section, Object.assign({
          cursor: "pointer",
          alignSelf: "end",
          height: "24px",
          onClick: () => sendTextMsg()
        }, {
          children: jsxRuntime.jsx(SendIcon, {})
        })), (loading || filesUploading) && jsxRuntime.jsx(Section, Object.assign({
          alignSelf: "end",
          height: "24px"
        }, {
...
const TypebarSection = /*#__PURE__*/styled__default["default"](Section).withConfig({
  displayName: "Typebar__TypebarSection",
  componentId: "sc-cu9bt3-1"
})(["gap:10px;@media ", "{gap:0px;}"], device.mobileL);
const SendSection = /*#__PURE__*/styled__default["default"](Section).withConfig({
  displayName: "Typebar__SendSection",
  componentId: "sc-cu9bt3-2"
})(["gap:11.5px;@media ", "{gap:7.5px;}"], device.mobileL);
const MultiLineInput = /*#__PURE__*/styled__default["default"].textarea.withConfig({
...
const FileInput = /*#__PURE__*/styled__default["default"].input.withConfig({
...
const EncryptionMessage = ({
  ...
  return jsxRuntime.jsxs(Section, Object.assign({
    ...
    children: [EncryptionMessageContent[id].IconComponent, jsxRuntime.jsx(Span$1, Object.assign({
      fontSize: "13px",
...
const FileCard = ({
  ...
  return jsxRuntime.jsxs(Section, Object.assign({
    ...
    })), jsxRuntime.jsx(FileDownloadIconAnchor, Object.assign({
      href: content,
      target: "_blank",
      rel: "noopener noreferrer",
      download: true
    }, {
      children: jsxRuntime.jsx(FileDownloadIcon, {
...
const MessageCard = ({
  ...
  const time = moment__default["default"](chat.timestamp).format('hh:mm a');
  return jsxRuntime.jsxs(Section, Object.assign({
    gap: "5px",
    ...
    children: [' ', jsxRuntime.jsx(Section, Object.assign({
      ...
      children: chat.messageContent.split('\n').map(str => jsxRuntime.jsx(Span$1, Object.assign({
        alignSelf: "start",
        textAlign: "left",
        fontSize: "16px",
        fontWeight: "400",
...
const Messages = ({
  ...
  if (chat.messageType === 'Image') {
    return jsxRuntime.jsx(ImageCard, {
      chat: chat,
      position: position
    });
  }
  ...
  if (chat.messageType === 'File') {
    return jsxRuntime.jsx(FileCard, {
      chat: chat,
      position: position
    });
  }

  return jsxRuntime.jsx(MessageCard, {
    chat: chat,
    position: position
  });
};
...
const MessageBox = () => {
  ...
  const renderDate = ({
    ...
    dates.add(dateNum);
    return jsxRuntime.jsx(Span$1, Object.assign({
      margin: "15px 0",
      fontSize: "14px",
      fontWeight: "600",
      color: "#AFAFB6",
  ...
  return jsxRuntime.jsxs(Section, Object.assign({
    ...
    children: [jsxRuntime.jsx(Container$2, Object.assign({
      width: "100%",
      ...
      children: jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [selectedChat && !selectedChat.publicKey ? jsxRuntime.jsx(EncryptionMessage, {
          id: 'NO_ENCRYPTED'
        }) : jsxRuntime.jsx(EncryptionMessage, {
          id: 'ENCRYPTED'
        }), loading ? jsxRuntime.jsx(Spinner, {}) : '', selectedMessages ? jsxRuntime.jsxs(MessageListCard, Object.assign({
          flexDirection: "column",
          justifyContent: "start",
          // width="100%"
          ...
          children: [selectedMessages === null || selectedMessages === void 0 ? void 0 : selectedMessages.messages.map((chat, index) => {
            const dateNum = moment__default["default"](chat.timestamp).format('L');
            return jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [dates.has(dateNum) ? null : renderDate({
                chat,
                dateNum
              }), jsxRuntime.jsx(Messages, {
                chat: chat
              }, index)]
            });
          }), requestFeedids.includes(selectedChatId) && jsxRuntime.jsxs(Section, Object.assign({
            gap: "5px",
            background: "#EDEDEE",
            padding: "8px 12px",
            margin: "5px 0",
            ...
            children: [jsxRuntime.jsx(Span$1, Object.assign({
              ...
              children: approveLoading ? jsxRuntime.jsx(Spinner, {
                color: "#fff",
                size: "24"
              }) : 'Accept'
            }))]
    ...
    })), !requestFeedids.includes(selectedChatId) && jsxRuntime.jsx(Typebar, {
      scrollToBottom: scrollToBottom
    })]
  }));
}; //styles

const MessageListCard = /*#__PURE__*/styled__default["default"](Section).withConfig({
  displayName: "MessageBox__MessageListCard",
  componentId: "sc-7co3u0-0"
})([""]);
const Container$2 = /*#__PURE__*/styled__default["default"](Section).withConfig({
...
const FileDownloadIcon = /*#__PURE__*/styled__default["default"].i.withConfig({
  displayName: "MessageBox__FileDownloadIcon",
  componentId: "sc-7co3u0-2"
})(["color:#575757;"]);
const FileDownloadIconAnchor = /*#__PURE__*/styled__default["default"].a.withConfig({
...
const ChatList = ({
  ...
  return jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: !!Object.keys(chatsFeed || {}).length && Object.keys(chatsFeed).map(id => jsxRuntime.jsx(ChatSnap, {
      chat: chatsFeed[id],
      id: id
    }, id))
  });
...
const RequestsFeedList = () => {
  ...
  return jsxRuntime.jsxs(ChatListCard$2, Object.assign({
    overflow: "hidden auto",
    justifyContent: "start",
    width: '100%',
    flexDirection: "column"
  }, {
    children: [(!loading || paginateLoading) && Object.keys(requestsFeed || {}).length ? jsxRuntime.jsx(ChatList, {
      chatsFeed: requestsFeed
    }) : !paginateLoading && loading && jsxRuntime.jsx(Section, Object.assign({
      margin: "10px  0"
    }, {
      children: jsxRuntime.jsx(Spinner, {})
    })), !loading && Object.keys(requestsFeed).length === 0 && jsxRuntime.jsx(Span$1, Object.assign({
      margin: '20px 0 0 0'
    }, {
    ...
    }), paginateLoading && jsxRuntime.jsx(Section, Object.assign({
      margin: "10px 0"
    }, {
      children: jsxRuntime.jsx(Spinner, {})
    }))]
...
const ChatListCard$2 = /*#__PURE__*/styled__default["default"](Section).withConfig({
...
const NotificationFeedList = ({
  ...
  return jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: !!Object.keys(notificationFeeds || {}).length && Object.keys(notificationFeeds).map(id => jsxRuntime.jsx(NotificationItem, {
...
const SpamNotificationFeedList = () => {
  ...
  React.useEffect(() => {
    if (!isInViewport1 || loading || Object.keys(spamNotifsFeed).length < notificationLimit) {
      return;
    }
  ...
  return jsxRuntime.jsxs(SpamNotifListCard, Object.assign({
    overflow: "hidden auto",
    justifyContent: "start",
    flexDirection: "column",
    width: "100%",
    ...
    children: [(!loading || paginateLoading) && Object.keys(spamNotifsFeed || {}).length ? jsxRuntime.jsx(Div, {
      children: jsxRuntime.jsx(NotificationFeedList, {
      ...
      children: jsxRuntime.jsx(Spinner, {})
    })), !loading && Object.keys(spamNotifsFeed).length === 0 && jsxRuntime.jsx(Span$1, Object.assign({
      margin: "20px 0 0 0"
    }, {
...
const SpamNotifListCard = /*#__PURE__*/styled__default["default"](Section).withConfig({
...
const Search = ({
  ...
  return jsxRuntime.jsxs(Container$1, Object.assign({
    ...
    children: [newChat && jsxRuntime.jsx(Section, Object.assign({
      width: "auto",
      cursor: "pointer",
      onClick: () => {
        setSearchedChats(null);
      ...
      children: [jsxRuntime.jsx(Input, {
        ...
        children: [!loading && !searchedText && jsxRuntime.jsx(Div, Object.assign({
          cursor: "pointer",
          width: "17.49px",
          height: "17.49px",
          onClick: () => onSearch()
        ...
        })), !loading && searchedText && jsxRuntime.jsx(Div, Object.assign({
          cursor: "pointer",
          onClick: () => {
            setSearchedText('');
            onSearchReset();
...
const Container$1 = /*#__PURE__*/styled__default["default"](Section).withConfig({
...
const SidebarPlaceholderContent = {
  SEARCH: {
    title: 'No Results',
    subTitle: '',
    IconComponent: jsxRuntime.jsx(SearchIcon, {
      height: "40",
      width: "40"
    })
  },
  NEW_CHAT: {
    ...
    IconComponent: jsxRuntime.jsx(NewMessage, {})
  },
  NOTIFICATION: {
...
const SidebarPlaceholder = ({
  ...
  return jsxRuntime.jsxs(Section, Object.assign({
    ...
    children: [SidebarPlaceholderContent[id].IconComponent, jsxRuntime.jsxs(Section, Object.assign({
      flexDirection: "column",
      gap: "7px"
    }, {
      children: [jsxRuntime.jsx(Span$1, Object.assign({
...
const ChatsFeedList = () => {
  ...
  return jsxRuntime.jsxs(ChatListCard$1, Object.assign({
    overflow: "hidden auto",
    justifyContent: "start",
    flexDirection: "column"
  }, {
    children: [(!loading || paginateLoading) && Object.keys(chatsFeed || {}).length ? jsxRuntime.jsx(ChatList, {
      chatsFeed: chatsFeed
    }) : !paginateLoading && loading && jsxRuntime.jsx(Section, Object.assign({
      margin: "10px 0"
    }, {
      children: jsxRuntime.jsx(Spinner, {})
    })), !loading && Object.keys(chatsFeed).length === 0 && jsxRuntime.jsx(SidebarPlaceholder, {
...
const ChatListCard$1 = /*#__PURE__*/styled__default["default"](Section).withConfig({
...
const InboxNotificationFeedList = () => {
  ...
  React.useEffect(() => {
    if (!isInViewport1 || loading || Object.keys(inboxNotifsFeed).length < notificationLimit) {
      return;
    }
  ...
  return jsxRuntime.jsxs(InboxNotifListCard, Object.assign({
    overflow: "hidden auto",
    justifyContent: "start",
    flexDirection: "column",
    padding: "0 3px"
  }, {
    children: [(!loading || paginateLoading) && Object.keys(inboxNotifsFeed || {}).length ? jsxRuntime.jsx(Div, {
      children: jsxRuntime.jsx(NotificationFeedList, {
      ...
      children: jsxRuntime.jsx(Spinner, {})
    })), !loading && Object.keys(inboxNotifsFeed).length === 0 && jsxRuntime.jsx(SidebarPlaceholder, {
...
const InboxNotifListCard = /*#__PURE__*/styled__default["default"](Section).withConfig({
...
const Tab = ({
  ...
  const {
    setSearchedNotifications
  } = React.useContext(NotificationMainStateContext); // const UnreadChats = () => {
  //   return (
  //     <Section
  //       borderRadius='100px'
  ...
  return jsxRuntime.jsx(Section, Object.assign({
    ...
    children: jsxRuntime.jsx(TabTitleSpan, Object.assign({
...
const SidebarSubTabs = ({
  ...
  return jsxRuntime.jsxs(SubContainer, Object.assign({
    justifyContent: "start",
    gap: "15px",
    padding: "15px 8px",
...
const Sidebar = () => {
  ...
  return jsxRuntime.jsxs(Section, Object.assign({
    ...
    children: [!newChat && jsxRuntime.jsx(SidebarTabs, {}), activeSubTab !== PUSH_SUB_TABS.REQUESTS && (activeTab === PUSH_TABS.CHATS || newChat) && jsxRuntime.jsx(Search, {
      feed: chatsFeed,
      handleSearch: handleChatSearch,
      onSearchReset: onChatSearchReset,
      placeholder: "Search name or domain"
    }), activeSubTab !== PUSH_SUB_TABS.SPAM && activeTab === PUSH_TABS.APP_NOTIFICATIONS && !newChat && jsxRuntime.jsx(Search, {
      feed: allInboxNotifFeed,
      handleSearch: handleNotifSearch,
      onSearchReset: () => setSearchedNotifications(null),
      placeholder: "Search Notification"
    }), !searchedChats && newChat && jsxRuntime.jsx(SidebarPlaceholder, {
      id: SIDEBAR_PLACEHOLDER_KEYS.NEW_CHAT
    }), !newChat && !chatsLoading && !searchedChats && activeTab === PUSH_TABS.CHATS && jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [jsxRuntime.jsx(SidebarSubTabs, {
        subTab: PushSubTabDetails.REQUESTS,
        tabValue: "REQUESTS",
        isClickable: !!Object.keys(requestsFeed).length
      }), activeSubTab !== PUSH_SUB_TABS.REQUESTS && jsxRuntime.jsx(ChatsFeedList, {})]
    }), !newChat && !searchedNotifications && activeTab === PUSH_TABS.APP_NOTIFICATIONS && jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [jsxRuntime.jsx(SidebarSubTabs, {
        subTab: PushSubTabDetails.SPAM,
        tabValue: "SPAM",
        isClickable: !!Object.keys(spamNotifsFeed).length
      }), activeSubTab !== PUSH_SUB_TABS.SPAM && jsxRuntime.jsx(InboxNotificationFeedList, {})]
    }), (activeTab === PUSH_TABS.CHATS || newChat) && jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [jsxRuntime.jsx(ChatListCard, Object.assign({
        overflow: "hidden auto",
        justifyContent: "start",
        gap: "2.5px",
        width: "100%",
        ...
        children: searchedChats && !!Object.keys(searchedChats).length && jsxRuntime.jsx(ChatList, {
          chatsFeed: searchedChats
        })
      })), searchedChats && !Object.keys(searchedChats).length && jsxRuntime.jsx(SidebarPlaceholder, {
        id: SIDEBAR_PLACEHOLDER_KEYS.SEARCH
      })]
    }), activeTab === PUSH_TABS.APP_NOTIFICATIONS && !newChat && jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [jsxRuntime.jsx(NotificationListCard, {
        children: searchedNotifications && !!Object.keys(searchedNotifications).length && jsxRuntime.jsx(NotificationFeedList, {
          notificationFeeds: searchedNotifications
        })
      }), searchedNotifications && !Object.keys(searchedNotifications).length && jsxRuntime.jsx(SidebarPlaceholder, {
        id: SIDEBAR_PLACEHOLDER_KEYS.SEARCH
      })]
    })]
  }));
...
const SubContainer = /*#__PURE__*/styled__default["default"](Section).withConfig({
...
const ChatListCard = /*#__PURE__*/styled__default["default"](Section).withConfig({
  displayName: "Sidebar__ChatListCard",
  componentId: "sc-nibeu-1"
})(["&::-webkit-scrollbar-thumb{background:rgb(181 181 186);border-radius:10px;}&::-webkit-scrollbar{width:5px;}"]);
const NotificationListCard = /*#__PURE__*/styled__default["default"](Div).withConfig({
...
const TabTitleSpan = /*#__PURE__*/styled__default["default"](Span$1).withConfig({
...
const Modal = () => {
  ...
  return jsxRuntime.jsxs(Section, Object.assign({
    ...
    children: [!selectedChatId && !activeSubTab && jsxRuntime.jsx(Sidebar, {}), !selectedChatId && activeSubTab === PUSH_SUB_TABS.REQUESTS && jsxRuntime.jsx(RequestsFeedList, {}), activeSubTab === PUSH_SUB_TABS.SPAM && jsxRuntime.jsx(SpamNotificationFeedList, {}), selectedChatId && (Object.keys(chatsFeed || {}).length || Object.keys(requestsFeed || {}).length || Object.keys(searchedChats || {}).length ? jsxRuntime.jsx(MessageBox, {}) : jsxRuntime.jsx(Spinner, {}))]
  }));
};
...
const ChatAndNotification = () => {
  ...
  React.useEffect(() => {
    ...
    setRequestsFeed({});
    setInboxNotifsFeed({});
    setSpamNotifsFeed({}); // set active tab if present
  ...
  return jsxRuntime.jsxs(Container, Object.assign({
    ...
    children: [jsxRuntime.jsx(MinimisedModalHeader, {
      onMaximizeMinimizeToggle: onClose !== null && onClose !== void 0 ? onClose : onMaximizeMinimizeToggle,
      modalOpen: modalOpen
    }), modalOpen && jsxRuntime.jsx(Modal, {})]
  }));
}; //styles

const Container = /*#__PURE__*/styled__default["default"](Section).withConfig({
...
const ChatAndNotificationWidget = ({
  ...
  return jsxRuntime.jsx(ChatAndNotificationPropsContext.Provider, Object.assign({
    value: chatAndNotificationPropsData
  }, {
    children: jsxRuntime.jsx(ChatAndNotificationMainContextProvider, {
      children: jsxRuntime.jsx(ChatMainStateContextProvider, {
        children: jsxRuntime.jsx(NotificationMainStateContextProvider, {
          children: jsxRuntime.jsx(ChatAndNotification, {})
        })
      })
    })
  }));
...
const SpacesUIProvider = ({
  ...
  const spacesObjectRef = React.useRef({});
  const [account, setAccount] = React.useState(spaceUI.account);
  const [signer, setSigner] = React.useState(spaceUI.signer);
  const [pgpPrivateKey, setPgpPrivateKey] = React.useState(spaceUI.pgpPrivateKey);
  const [env, setEnv] = React.useState(spaceUI.env);
  const [spaceWidgetId, setSpaceWidgetId] = React.useState('');
  const [speakerData, setSpeakerData] = React.useState({});
  const [trendingListData, setTrendingListData] = React.useState(null);
  const [spaceInfo, setSpaceInfo] = React.useState({});
  const [spaceObjectData, setSpaceObjectData] = React.useState(PushAPI__namespace.space.initSpaceData);
  const [mySpaces, setMySpaces] = React.useState({
    apiData: [],
    currentPage: 1,
    lastPage: 2
  });
  const [popularSpaces, setPopularSpaces] = React.useState({
    apiData: [],
    currentPage: 1,
    lastPage: 2
  });
  const [spaceRequests, setSpaceRequests] = React.useState({
    apiData: [],
    currentPage: 1,
    lastPage: 2
  });
  ...
  const livepeerClient = react.createReactClient({
    provider: react.studioProvider({
  ...
  const initSpaceObject = spaceId => __awaiter(void 0, void 0, void 0, function* () {
    spacesObjectRef.current = new PushAPI__namespace.space.Space({
      signer,
      pgpPrivateKey,
      address: account,
      chainId: 5,
  ...
  const setMySpacePaginationInfo = paginationInfo => {
    ...
    setMySpaces(prevState => {
      ...
      if (apiData) {
        ...
        return Object.assign(Object.assign({}, prevState), uniqueSpaces && prevState.apiData && {
  ...
  const isSpeaker = Boolean(((_d = spaceObjectData === null || spaceObjectData === void 0 ? void 0 : spaceObjectData.members) === null || _d === void 0 ? void 0 : _d.find(member => {
    if ((account === null || account === void 0 ? void 0 : account.toUpperCase()) === spaceObjectData.spaceCreator.replace('eip155:', '').toUpperCase()) return false;
    const address = member.wallet.replace('eip155:', '');
    return (address === null || address === void 0 ? void 0 : address.toUpperCase()) === (account === null || account === void 0 ? void 0 : account.toUpperCase()) && member.isSpeaker;
  ...
  const isListener = Boolean(((_f = spaceObjectData === null || spaceObjectData === void 0 ? void 0 : spaceObjectData.members) === null || _f === void 0 ? void 0 : _f.find(member => {
    console.log('member', member);
    const address = member.wallet.replace('eip155:', '');
    return address.toUpperCase() === account.toUpperCase() && !member.isSpeaker;
  })) || ((_g = spaceObjectData === null || spaceObjectData === void 0 ? void 0 : spaceObjectData.pendingMembers) === null || _g === void 0 ? void 0 : _g.find(member => {
  ...
  return jsxRuntime.jsx(react.LivepeerConfig, Object.assign({
    client: livepeerClient
  }, {
    children: jsxRuntime.jsx(ThemeContext.Provider, Object.assign({
      value: PROVIDER_THEME
    }, {
      children: jsxRuntime.jsx(SpaceDataContext.Provider, Object.assign({
        value: value
      }, {
        children: children
      }))
...
exports.CHAT_SOCKET_TYPE = CHAT_SOCKET_TYPE;
exports.Chat = Chat;
exports.ChatAndNotificationWidget = ChatAndNotificationWidget;
exports.Constants = Constants;
exports.Container = Container$j;
exports.CoreContractChainId = CoreContractChainId;
exports.FILE_ICON = FILE_ICON;
exports.Heading = Heading$1;
exports.Image = Image$4;
...
exports.PUBLIC_GOOGLE_TOKEN = PUBLIC_GOOGLE_TOKEN;
exports.PUSH_SUB_TABS = PUSH_SUB_TABS;
exports.PUSH_TABS = PUSH_TABS;
exports.ParseMarkdownText = ParseMarkdownText;
exports.ProfilePicture = ProfilePicture;
exports.PushSubTabTitle = PushSubTabTitle;
exports.SIDEBAR_PLACEHOLDER_KEYS = SIDEBAR_PLACEHOLDER_KEYS;
exports.SpacesUI = SpacesUI;
exports.SpacesUIProvider = SpacesUIProvider;
exports.SubscribedModal = SubscribedModal;
exports.Text = Text$1;
exports.allowedNetworks = allowedNetworks;
exports.chatLimit = chatLimit;
exports.device = device;
exports.lightTheme = lightTheme$2;
exports.notificationBaseTheme = baseTheme;
exports.notificationDarkTheme = darkTheme;
exports.notificationLightTheme = lightTheme$1;
exports.notificationLimit = notificationLimit;
exports.requestLimit = requestLimit$1;
