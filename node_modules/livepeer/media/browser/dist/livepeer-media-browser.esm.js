import { version, createStorage } from '@livepeer/core';
...
var allKeyTriggers = ['KeyF', 'KeyK', 'KeyM', 'KeyI', 'KeyV', 'Space', 'ArrowRight', 'ArrowLeft'];
...
var addEventListeners = function addEventListeners(store) {
  ...
  var storeListener = store.subscribe(function (store) {
    return store._element;
  }, function (element) {
    var _destroy;
    (_destroy = _destroy2) === null || _destroy === void 0 ? void 0 : _destroy();
  ...
  return {
    destroy: function destroy() {
      var _destroy3;
      storeListener === null || storeListener === void 0 ? void 0 : storeListener();
      (_destroy3 = _destroy2) === null || _destroy3 === void 0 ? void 0 : _destroy3();
    }
  };
};
var previousPromise;
var addEffectsToStore = function addEffectsToStore(store, options) {
  ...
  return store.subscribe( /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(current, prev) {
      var _current$_mediaStream, _current$_mediaStream2, _current$_mediaStream3, audioTracks, _iterator, _step, audioTrack, _current$_mediaStream4, _current$_mediaStream5, _current$_mediaStream6, videoTracks, _iterator2, _step2, videoTrack, _store$getState2, device, isFullscreen, isPictureInPicture;
