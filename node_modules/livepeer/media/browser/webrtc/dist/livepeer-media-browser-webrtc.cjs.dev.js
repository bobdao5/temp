...
function createPeerConnection(host) {
  ...
  var iceServers = host ? [{
    urls: "stun:".concat(host)
  }, {
    urls: "turn:".concat(host),
    username: 'livepeer',
    credential: 'livepeer'
  }] : [];
...
function _negotiateConnectionWithClientOffer() {
  _negotiateConnectionWithClientOffer = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee(peerConnection, endpoint, ofr, timeout) {
    var response, answerSDP, sdpLinkHeader, errorMessage;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return postSDPOffer(endpoint, ofr.sdp, timeout);
          case 3:
          ...
          case 10:
            ...
            return _context.abrupt("return", parseIceServersFromLinkHeader(sdpLinkHeader));
          case 14:
            _context.next = 16;
            return response.text();
          case 16:
...
function constructClientOffer(_x5, _x6) {
...
function postSDPOffer(_x7, _x8, _x9) {
  return _postSDPOffer.apply(this, arguments);
}
function _postSDPOffer() {
  _postSDPOffer = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee3(endpoint, data, timeout) {
...
function getRedirectUrl(_x10, _x11, _x12) {
...
function waitToCompleteICEGathering(_x13) {
...
function parseIceServersFromLinkHeader(iceString) {
  try {
    ...
    return servers && ((_servers$length = servers === null || servers === void 0 ? void 0 : servers.length) !== null && _servers$length !== void 0 ? _servers$length : 0) > 0 ? servers : null;
  } catch (e) {
    console.error(e);
  }
  return null;
    ...
    if (peerConnection) {
      ...
      peerConnection.ontrack = /*#__PURE__*/function () {
        var _ref = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee(event) {
          var track, currentTracks, streamAlreadyHasVideoTrack, streamAlreadyHasAudioTrack, _callbacks$onError;
          return asyncToGenerator._regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                ...
                case 20:
                  ...
                  callbacks === null || callbacks === void 0 ? void 0 : (_callbacks$onError = callbacks.onError) === null || _callbacks$onError === void 0 ? void 0 : _callbacks$onError.call(callbacks, _context.t1);
                case 23:
                case "end":
                  return _context.stop();
              }
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 3:
                  ofr = _context3.sent;
                  _context3.next = 6;
                  return negotiateConnectionWithClientOffer(peerConnection, redirectUrlString, ofr, config === null || config === void 0 ? void 0 : config.sdpTimeout);
                case 6:
                  _context3.next = 11;
                  break;
                case 8:
                  ...
                  callbacks === null || callbacks === void 0 ? void 0 : (_callbacks$onError3 = callbacks.onError) === null || _callbacks$onError3 === void 0 ? void 0 : _callbacks$onError3.call(callbacks, _context3.t0);
                case 11:
                case "end":
                  return _context3.stop();
              }
  ...
  getRedirectUrl(ingestUrl, abortController, config === null || config === void 0 ? void 0 : config.sdpTimeout).then(function (redirectUrl) {
    ...
    if (peerConnection) {
      ...
      disconnectStream = function disconnectStream() {
        fetch__default["default"](redirectUrlString, {
          method: 'DELETE',
          mode: 'cors'
        }).catch(function (e) {
          var _callbacks$onError4;
    ...
    return callbacks === null || callbacks === void 0 ? void 0 : (_callbacks$onError5 = callbacks.onError) === null || _callbacks$onError5 === void 0 ? void 0 : _callbacks$onError5.call(callbacks, e);
  });
  return {
    destroy: function destroy() {
