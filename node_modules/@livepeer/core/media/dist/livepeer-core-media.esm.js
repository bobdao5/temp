export { D as DEFAULT_AUTOHIDE_TIME, a as DEFAULT_VOLUME_LEVEL, c as createControllerStore, g as getMediaSourceType, s as sanitizeMediaControllerState } from '../../dist/controller-dad64b1d.esm.js';
...
class MetricsStatus {
  ...
  getMetrics() {
    const currentMetrics = {
      ...
      ttff: this.firstFrameTime > 0 ? Math.max(this.firstFrameTime - this.requestedPlayTime, 0) : 0
    };
