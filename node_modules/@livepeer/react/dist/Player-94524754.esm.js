...
import { useVolume, useBaseSlider, useControlsContainer, useFullscreenButton, useTimeDisplay, useBroadcast, usePlayButton, useProgress, usePlayer } from '@livepeer/core-react/components';
import * as React from 'react';
import { useMemo, useCallback } from 'react';
import 'core-js/modules/es.object.to-string.js';
import 'core-js/modules/es.regexp.to-string.js';
import { sanitizeMediaControllerState, omit, ACCESS_CONTROL_ERROR_MESSAGE, STREAM_OFFLINE_ERROR_MESSAGE } from 'livepeer';
import { styling } from 'livepeer/media/browser/styling';
import { createNewWHIP, changeMediaStream, getMediaDevices, getUserMedia, getDisplayMedia, createNewWHEP, isWebRTCSupported } from 'livepeer/media/browser/webrtc';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { b as MediaControllerContext, u as useMediaController, a as useTheme, M as MediaControllerProvider } from './useTheme-0cc73d71.esm.js';
...
import { isPictureInPictureSupported, canPlayMediaNatively } from 'livepeer/media/browser';
...
var ControlsContainer = function ControlsContainer(props) {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [poster ? /*#__PURE__*/jsx("div", {
      ...
      onMouseUp: containerProps.onPress
    }), showLoadingSpinner && !isLoaded && !(error !== null && error !== void 0 && error.type) && /*#__PURE__*/jsxs("div", {
      className: styling.controlsContainer.background(),
      onMouseUp: containerProps.onPress,
    ...
    }), (error === null || error === void 0 ? void 0 : error.type) && /*#__PURE__*/jsx("div", {
      className: styling.controlsContainer.background(),
      onMouseUp: containerProps.onPress,
      children: (error === null || error === void 0 ? void 0 : error.type) === 'access-control' ? /*#__PURE__*/jsx(PrivateStreamError, {}) : (error === null || error === void 0 ? void 0 : error.type) === 'offline' ? /*#__PURE__*/jsx(OfflineStreamError, {
        isBroadcast: isBroadcast
      }) : /*#__PURE__*/jsx(GenericError, {
        isBroadcast: isBroadcast
      })
    }), isLoaded && !(error !== null && error !== void 0 && error.type) && /*#__PURE__*/jsxs(Fragment, {
      children: [/*#__PURE__*/jsx("div", {
...
var HLSVideoPlayer = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  return !(playbackError !== null && playbackError !== void 0 && playbackError.type) ? /*#__PURE__*/jsx("video", {
    className: styling.media.video({
      size: fullscreen ? 'fullscreen' : objectFit
    }),
    loop: loop,
