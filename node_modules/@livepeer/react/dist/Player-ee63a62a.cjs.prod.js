...
var webrtc = require('livepeer/media/browser/webrtc');
var jsxRuntime = require('react/jsx-runtime');
var useTheme = require('./useTheme-9f64282d.cjs.prod.js');
...
var WebRTCBroadcast = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  React__namespace.useEffect(function () {
    return store.subscribe(stateSelector, function (state, prevState) {
      return onPlaybackStatusUpdate === null || onPlaybackStatusUpdate === void 0 ? void 0 : onPlaybackStatusUpdate(livepeer.sanitizeMediaControllerState(state), livepeer.sanitizeMediaControllerState(prevState));
    });
  ...
  }, [webrtcConfig, aspectRatio, _element, onConnected, ingestUrl, onBroadcastError, onErrorComposed]);
  React__namespace.useEffect(function () {
...
var AudioToggle = function AudioToggle(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    }, livepeer.omit(buttonProps, 'onPress', 'size')))
  });
};
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(Dialog__namespace.Root, {
      children: [/*#__PURE__*/jsxRuntime.jsx(Dialog__namespace.Trigger, {
        ...
        }, livepeer.omit(props, 'icon', 'size', 'streamConstraints')), {}, {
...
var Screenshare = function Screenshare(props) {
  ...
  }, livepeer.omit(props, 'icon', 'options', 'size')), {}, {
...
var ControlsContainer = function ControlsContainer(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [poster ? /*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      onMouseUp: containerProps.onPress
    }), showLoadingSpinner && !isLoaded && !(error !== null && error !== void 0 && error.type) && /*#__PURE__*/jsxRuntime.jsxs("div", {
      className: styling.styling.controlsContainer.background(),
      onMouseUp: containerProps.onPress,
    ...
    }), (error === null || error === void 0 ? void 0 : error.type) && /*#__PURE__*/jsxRuntime.jsx("div", {
      className: styling.styling.controlsContainer.background(),
      onMouseUp: containerProps.onPress,
      children: (error === null || error === void 0 ? void 0 : error.type) === 'access-control' ? /*#__PURE__*/jsxRuntime.jsx(PrivateStreamError, {}) : (error === null || error === void 0 ? void 0 : error.type) === 'offline' ? /*#__PURE__*/jsxRuntime.jsx(OfflineStreamError, {
        isBroadcast: isBroadcast
      }) : /*#__PURE__*/jsxRuntime.jsx(GenericError, {
        isBroadcast: isBroadcast
      })
    }), isLoaded && !(error !== null && error !== void 0 && error.type) && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx("div", {
...
var Volume = function Volume(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("button", objectSpread2._objectSpread2({
      ...
      "aria-label": title,
      onClick: buttonProps.onPress
    }, livepeer.omit(buttonProps, 'onPress', 'size'))), progressProps.shown && /*#__PURE__*/jsxRuntime.jsx(BaseSlider, objectSpread2._objectSpread2({
      ariaName: "volume",
...
var HLSVideoPlayer = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  React__namespace.useEffect(function () {
    if (_element && src) {
      ...
      var _createNewHls = hls.createNewHls(src === null || src === void 0 ? void 0 : src.src, _element, {
          ...
          autoplay: autoPlay,
          xhrSetup: function xhrSetup(xhr, _url) {
  ...
  }, [autoPlay, hlsConfig, onDurationChange, onCanPlay, _element, src, onLive, onPlaybackError, allowCrossOriginCredentials]);
  return !(playbackError !== null && playbackError !== void 0 && playbackError.type) ? /*#__PURE__*/jsxRuntime.jsx("video", {
    className: styling.styling.media.video({
      size: fullscreen ? 'fullscreen' : objectFit
    }),
    loop: loop,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              return _context.abrupt("return", onPlaybackError === null || onPlaybackError === void 0 ? void 0 : onPlaybackError(new Error(livepeer.STREAM_OFFLINE_ERROR_MESSAGE)));
            case 13:
              ...
              return _context.abrupt("return", onPlaybackError === null || onPlaybackError === void 0 ? void 0 : onPlaybackError(new Error(livepeer.ACCESS_CONTROL_ERROR_MESSAGE)));
            case 16:
              _context.next = 22;
              break;
            case 18:
...
var WebRTCVideoPlayer = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  React__namespace.useEffect(function () {
    if (metadata !== null && metadata !== void 0 && metadata.bframes) {
      onPlaybackError(new Error('Metadata indicates that WebRTC playback contains bframes.'));
    }
...
var InternalVideoPlayer = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  var playbackMappedSources = React__namespace.useMemo(function () {
    ...
    return src === null || src === void 0 ? void 0 : (_src$filter = src.filter(function (s) {
      return lowLatency ? true : s.type !== 'webrtc';
  ...
  var _React$useMemo3 = React__namespace.useMemo(function () {
      return debounce(incrementSourceIndex, 1000 * Math.pow(2, currentSourceIndex));
  ...
  React__namespace.useEffect(function () {
    if ((playbackError === null || playbackError === void 0 ? void 0 : playbackError.type) === 'offline' && (currentPlaybackSource === null || currentPlaybackSource === void 0 ? void 0 : currentPlaybackSource.type) !== 'hls') {
  ...
  React__namespace.useEffect(function () {
    if ((playbackError === null || playbackError === void 0 ? void 0 : playbackError.type) === 'unknown') {
  ...
  React__namespace.useEffect(function () {
    ...
    if (shouldTryNextSource) {
      var _debouncedIncrementSo3;
      debouncedIncrementSourceIndexRef === null || debouncedIncrementSourceIndexRef === void 0 ? void 0 : (_debouncedIncrementSo3 = debouncedIncrementSourceIndexRef.current) === null || _debouncedIncrementSo3 === void 0 ? void 0 : _debouncedIncrementSo3.call(debouncedIncrementSourceIndexRef);
    }
