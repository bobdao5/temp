...
export declare const useTheme: (theme?: ThemeConfig) => Partial<{
    borderStyles: {
    ...
    fontWeights: {
        titleFontWeight?: import("livepeer/media").FontWeights | undefined;
        errorTitleFontWeight?: import("livepeer/media").FontWeights | undefined;
    };
    sizes: {
