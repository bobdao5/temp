...
export declare const useSourceMimeTyped: <TElement, TPoster, TPlaybackPolicyObject extends object, TSlice>({ src, playbackId, jwt, refetchPlaybackInfoInterval, autoUrlUpload, playbackInfo, screenWidth, accessKey, onAccessKeyRequest, }: UseSourceMimeTypedProps<TElement, TPoster, TPlaybackPolicyObject, TSlice>) => {
