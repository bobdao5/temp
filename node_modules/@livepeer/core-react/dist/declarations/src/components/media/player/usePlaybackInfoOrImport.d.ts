 ...
 */
export declare const usePlaybackInfoOrImport: ({ decentralizedSrcOrPlaybackId, playbackId, refetchPlaybackInfoInterval, autoUrlUpload, onAssetStatusChange, }: UsePlaybackInfoOrImportProps) => import("@livepeer/core").PlaybackInfo | undefined;
